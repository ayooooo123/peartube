...
namespace margelo::nitro::nitrovlc {
  ...
  public:
    Track() = default;
    explicit Track(double id, std::string name): id(id), name(name) {}
...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::nitrovlc::Track> final {
    static inline margelo::nitro::nitrovlc::Track fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrovlc::Track(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrovlc::Track& arg) {
