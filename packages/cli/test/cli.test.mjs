...
test('package.json defines standalone relay build scripts', async (t) => {
  ...
  t.is(pkg.scripts['test'], 'brittle test/admission.test.mjs test/alerts.test.mjs test/archive-ui.test.mjs test/archive.test.mjs test/blob-downloader.test.mjs test/cli.test.mjs test/config.test.mjs test/local-drive-mirror.test.mjs test/moderation.test.mjs test/relay-seeding.test.mjs test/reports.test.mjs test/service.test.mjs test/status.test.mjs')
