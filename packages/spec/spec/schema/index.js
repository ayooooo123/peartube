...
const encoding196_7 = encoding44_11
// @peartube/preview-storage-limit-response.consequences
const encoding196_8 = encoding44_11
...
const encoding196 = {
  preencode(state, m) {
    ...
    if (m.affectedCategories) encoding196_7.preencode(state, m.affectedCategories)
    if (m.consequences) encoding196_8.preencode(state, m.consequences)
    if (m.errorCode) c.string.preencode(state, m.errorCode)
  },
  encode(state, m) {
    const flags =
    ...
    if (m.affectedCategories) encoding196_7.encode(state, m.affectedCategories)
    if (m.consequences) encoding196_8.encode(state, m.consequences)
    if (m.errorCode) c.string.encode(state, m.errorCode)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      affectedCategories: (flags & 2) !== 0 ? encoding196_7.decode(state) : null,
      consequences: (flags & 4) !== 0 ? encoding196_8.decode(state) : null,
      feasible: (flags & 8) !== 0,
...
const encoding198_12 = encoding44_11
...
const encoding198 = {
  preencode(state, m) {
    ...
    if (m.recentFailureCodes) encoding198_12.preencode(state, m.recentFailureCodes)
  ...
  encode(state, m) {
    ...
    if (m.recentFailureCodes) encoding198_12.encode(state, m.recentFailureCodes)
  ...
  decode(state) {
    ...
    return {
      ...
      recentFailureCodes: (flags & 16) !== 0 ? encoding198_12.decode(state) : null,
...
const encoding206 = {
  preencode(state, m) {
    const flags =
      ...
      (m.indexServiceAnnouncementsJson ? 2048 : 0)
    ...
    if (m.indexServiceAnnouncementsJson) c.string.preencode(state, m.indexServiceAnnouncementsJson)
  },
  encode(state, m) {
    const flags =
      (m.uploadPermission ? 1 : 0) |
    ...
    if (m.indexServiceAnnouncementsJson) c.string.encode(state, m.indexServiceAnnouncementsJson)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      indexServiceAnnouncementsJson: (flags & 2048) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding207 = {
  preencode(state, m) {
    const flags =
      ...
      (m.indexServiceAnnouncementsJson ? 8192 : 0)
  ...
  decode(state) {
    ...
    return {
      ...
      indexServiceAnnouncementsJson: (flags & 8192) !== 0 ? c.string.decode(state) : null
    }
  }
}

// @peartube/set-network-policy-response
const encoding208 = encoding73
...
const encoding212_9 = encoding44_11
...
const encoding212 = {
  preencode(state, m) {
    ...
    if (m.limitations) encoding212_9.preencode(state, m.limitations)
    if (m.errorCode) c.string.preencode(state, m.errorCode)
  },
  encode(state, m) {
    const flags =
    ...
    if (m.limitations) encoding212_9.encode(state, m.limitations)
    if (m.errorCode) c.string.encode(state, m.errorCode)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      limitations: (flags & 4) !== 0 ? encoding212_9.decode(state) : null,
      errorCode: (flags & 8) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding217 = encoding166

// @peartube/get-video-metadata-response.video
const encoding218_0 = encoding86_0

// @peartube/get-video-metadata-response
const encoding218 = {
  preencode(state, m) {
    encoding218_0.preencode(state, m.video)
  },
  encode(state, m) {
    encoding218_0.encode(state, m.video)
  },
  decode(state) {
    const r0 = encoding218_0.decode(state)
...
const encoding221 = encoding13

// @peartube/set-video-thumbnail-response
const encoding222 = encoding13

// @peartube/desktop-browse-video.tags
const encoding223_8 = encoding44_11
// @peartube/desktop-browse-video.sections
const encoding223_10 = encoding44_11
...
const encoding223 = {
  preencode(state, m) {
    ...
    if (m.tags) encoding223_8.preencode(state, m.tags)
    if (m.accentHex) c.string.preencode(state, m.accentHex)
    if (m.sections) encoding223_10.preencode(state, m.sections)
    if (m.thumbnailUrl) c.string.preencode(state, m.thumbnailUrl)
    if (m.path) c.string.preencode(state, m.path)
    if (m.blobId) c.string.preencode(state, m.blobId)
    if (m.blobsCoreKey) c.string.preencode(state, m.blobsCoreKey)
  ...
  encode(state, m) {
    ...
    if (m.tags) encoding223_8.encode(state, m.tags)
    if (m.accentHex) c.string.encode(state, m.accentHex)
    if (m.sections) encoding223_10.encode(state, m.sections)
    if (m.thumbnailUrl) c.string.encode(state, m.thumbnailUrl)
    if (m.path) c.string.encode(state, m.path)
    if (m.blobId) c.string.encode(state, m.blobId)
    if (m.blobsCoreKey) c.string.encode(state, m.blobsCoreKey)
  ...
  decode(state) {
    ...
    return {
      ...
      tags: (flags & 8) !== 0 ? encoding223_8.decode(state) : null,
      accentHex: (flags & 16) !== 0 ? c.string.decode(state) : null,
      sections: (flags & 32) !== 0 ? encoding223_10.decode(state) : null,
...
const encoding224_0 = c.array(c.frame(encoding223))
// @peartube/desktop-browse-sections.subscriptions
const encoding224_1 = encoding224_0
// @peartube/desktop-browse-sections.library
const encoding224_2 = encoding224_0
// @peartube/desktop-browse-sections.studio
const encoding224_3 = encoding224_0
// @peartube/desktop-browse-sections.diagnostics
const encoding224_4 = encoding224_0
...
const encoding224 = {
  preencode(state, m) {
    ...
    if (m.home) encoding224_0.preencode(state, m.home)
    if (m.subscriptions) encoding224_1.preencode(state, m.subscriptions)
    if (m.library) encoding224_2.preencode(state, m.library)
    if (m.studio) encoding224_3.preencode(state, m.studio)
    if (m.diagnostics) encoding224_4.preencode(state, m.diagnostics)
  },
  encode(state, m) {
    const flags =
      (m.home ? 1 : 0) |
    ...
    if (m.home) encoding224_0.encode(state, m.home)
    if (m.subscriptions) encoding224_1.encode(state, m.subscriptions)
    if (m.library) encoding224_2.encode(state, m.library)
    if (m.studio) encoding224_3.encode(state, m.studio)
    if (m.diagnostics) encoding224_4.encode(state, m.diagnostics)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      home: (flags & 1) !== 0 ? encoding224_0.decode(state) : null,
      subscriptions: (flags & 2) !== 0 ? encoding224_1.decode(state) : null,
      library: (flags & 4) !== 0 ? encoding224_2.decode(state) : null,
      studio: (flags & 8) !== 0 ? encoding224_3.decode(state) : null,
      diagnostics: (flags & 16) !== 0 ? encoding224_4.decode(state) : null
    }
  }
}
...
const encoding226_0 = encoding44_11
// @peartube/desktop-browse-state.identityChannelKeys
const encoding226_1 = encoding44_11
...
const encoding226 = {
  preencode(state, m) {
    ...
    if (m.subscriptionChannelKeys) encoding226_0.preencode(state, m.subscriptionChannelKeys)
    if (m.identityChannelKeys) encoding226_1.preencode(state, m.identityChannelKeys)
  ...
  encode(state, m) {
    ...
    if (m.subscriptionChannelKeys) encoding226_0.encode(state, m.subscriptionChannelKeys)
    if (m.identityChannelKeys) encoding226_1.encode(state, m.identityChannelKeys)
  ...
  decode(state) {
    ...
    return {
      subscriptionChannelKeys: (flags & 1) !== 0 ? encoding226_0.decode(state) : null,
      identityChannelKeys: (flags & 2) !== 0 ? encoding226_1.decode(state) : null,
...
const encoding227_1 = c.frame(encoding224)
// @peartube/desktop-browse-snapshot.stats
const encoding227_2 = c.frame(encoding225)
// @peartube/desktop-browse-snapshot.state
const encoding227_3 = c.frame(encoding226)
...
const encoding227 = {
  preencode(state, m) {
    ...
    encoding227_1.preencode(state, m.sections)
    encoding227_2.preencode(state, m.stats)
    encoding227_3.preencode(state, m.state)
  },
  encode(state, m) {
    ...
    encoding227_1.encode(state, m.sections)
    encoding227_2.encode(state, m.stats)
    encoding227_3.encode(state, m.state)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      sections: encoding227_1.decode(state),
      stats: encoding227_2.decode(state),
      state: encoding227_3.decode(state)
    }
  }
}
...
const encoding229_5 = c.frame(encoding227)
...
const encoding229 = {
  preencode(state, m) {
    ...
    encoding229_5.preencode(state, m.snapshot)
  },
  encode(state, m) {
    const flags =
    ...
    encoding229_5.encode(state, m.snapshot)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      snapshot: encoding229_5.decode(state)
    }
  }
}

// @peartube/desktop-shutdown-request
const encoding230 = encoding0

// @peartube/desktop-shutdown-response
const encoding231 = encoding13

// @peartube/desktop-refresh-browse-request
const encoding232 = encoding0

// @peartube/desktop-refresh-browse-response.snapshot
const encoding233_0 = encoding229_5

// @peartube/desktop-refresh-browse-response
const encoding233 = {
  preencode(state, m) {
    encoding233_0.preencode(state, m.snapshot)
  },
  encode(state, m) {
    encoding233_0.encode(state, m.snapshot)
  },
  decode(state) {
    const r0 = encoding233_0.decode(state)
...
const encoding246 = encoding0

// @peartube/get-status-response.status
const encoding247_0 = c.frame(encoding245)

// @peartube/get-status-response
const encoding247 = {
  preencode(state, m) {
    encoding247_0.preencode(state, m.status)
  },
  encode(state, m) {
    encoding247_0.encode(state, m.status)
  },
  decode(state) {
    const r0 = encoding247_0.decode(state)
...
const encoding256_0 = c.array(c.frame(encoding254))

// @peartube/global-search-videos-response
const encoding256 = {
  preencode(state, m) {
    encoding256_0.preencode(state, m.results)
  },
  encode(state, m) {
    encoding256_0.encode(state, m.results)
  },
  decode(state) {
    const r0 = encoding256_0.decode(state)
...
const encoding260_4 = c.array(c.frame(encoding258))
// @peartube/index-work.episode
const encoding260_5 = c.frame(encoding259)
...
const encoding260 = {
  preencode(state, m) {
    ...
    encoding260_4.preencode(state, m.externalRefs)
    if (m.episode) encoding260_5.preencode(state, m.episode)
  },
  encode(state, m) {
    const flags =
      (m.entityId ? 1 : 0) |
    ...
    encoding260_4.encode(state, m.externalRefs)
    if (m.episode) encoding260_5.encode(state, m.episode)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      externalRefs: encoding260_4.decode(state),
      episode: (flags & 8) !== 0 ? encoding260_5.decode(state) : null
    }
  }
}
...
const encoding263_3 = encoding44_11
...
const encoding263 = {
  preencode(state, m) {
    ...
    encoding263_3.preencode(state, m.languages)
  },
  encode(state, m) {
    ...
    encoding263_3.encode(state, m.languages)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      languages: encoding263_3.decode(state)
    }
  }
}
...
const encoding265_8 = encoding44_11
// @peartube/index-rendition.audioTracks
const encoding265_9 = c.array(c.frame(encoding263))
// @peartube/index-rendition.subtitleTracks
const encoding265_10 = c.array(c.frame(encoding264))
...
const encoding265 = {
  preencode(state, m) {
    ...
    encoding265_8.preencode(state, m.hdrFormats)
    encoding265_9.preencode(state, m.audioTracks)
    encoding265_10.preencode(state, m.subtitleTracks)
  ...
  encode(state, m) {
    ...
    encoding265_8.encode(state, m.hdrFormats)
    encoding265_9.encode(state, m.audioTracks)
    encoding265_10.encode(state, m.subtitleTracks)
  ...
  decode(state) {
    ...
    return {
      ...
      hdrFormats: encoding265_8.decode(state),
      audioTracks: encoding265_9.decode(state),
      subtitleTracks: encoding265_10.decode(state),
...
const encoding272_1 = c.frame(encoding270)
// @peartube/index-verification.catalogHead
const encoding272_2 = c.frame(encoding271)
...
const encoding272 = {
  preencode(state, m) {
    ...
    if (m.publisherDescriptor) encoding272_1.preencode(state, m.publisherDescriptor)
    if (m.catalogHead) encoding272_2.preencode(state, m.catalogHead)
  },
  encode(state, m) {
    ...
    if (m.publisherDescriptor) encoding272_1.encode(state, m.publisherDescriptor)
    if (m.catalogHead) encoding272_2.encode(state, m.catalogHead)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const flags = c.uint.decode(state)
    ...
    return {
      state: r0,
      publisherDescriptor: (flags & 1) !== 0 ? encoding272_1.decode(state) : null,
      catalogHead: (flags & 2) !== 0 ? encoding272_2.decode(state) : null
    }
  }
}

// @peartube/index-candidate-v2.work
const encoding273_2 = c.frame(encoding260)
// @peartube/index-candidate-v2.edition
const encoding273_3 = c.frame(encoding261)
// @peartube/index-candidate-v2.publication
const encoding273_4 = c.frame(encoding262)
// @peartube/index-candidate-v2.rendition
const encoding273_5 = c.frame(encoding265)
// @peartube/index-candidate-v2.asset
const encoding273_6 = c.frame(encoding266)
// @peartube/index-candidate-v2.provenance
const encoding273_7 = c.frame(encoding267)
// @peartube/index-candidate-v2.availability
const encoding273_8 = c.frame(encoding268)
// @peartube/index-candidate-v2.verification
const encoding273_9 = c.frame(encoding272)
// @peartube/index-candidate-v2.sourceIndexers
const encoding273_10 = c.array(c.frame(encoding269))
...
const encoding273 = {
  preencode(state, m) {
    ...
    encoding273_2.preencode(state, m.work)
    state.end++ // max flag is 1 so always one byte

    if (m.edition) encoding273_3.preencode(state, m.edition)
    encoding273_4.preencode(state, m.publication)
    encoding273_5.preencode(state, m.rendition)
    encoding273_6.preencode(state, m.asset)
    encoding273_7.preencode(state, m.provenance)
    encoding273_8.preencode(state, m.availability)
    encoding273_9.preencode(state, m.verification)
    encoding273_10.preencode(state, m.sourceIndexers)
  },
  encode(state, m) {
    ...
    encoding273_2.encode(state, m.work)
    c.uint.encode(state, flags)

    if (m.edition) encoding273_3.encode(state, m.edition)
    encoding273_4.encode(state, m.publication)
    encoding273_5.encode(state, m.rendition)
    encoding273_6.encode(state, m.asset)
    encoding273_7.encode(state, m.provenance)
    encoding273_8.encode(state, m.availability)
    encoding273_9.encode(state, m.verification)
    encoding273_10.encode(state, m.sourceIndexers)
  },
  decode(state) {
    const r0 = c.uint.decode(state)
    const r1 = c.string.decode(state)
    const r2 = encoding273_2.decode(state)
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      candidateRef: r1,
      work: r2,
      edition: (flags & 1) !== 0 ? encoding273_3.decode(state) : null,
      publication: encoding273_4.decode(state),
      rendition: encoding273_5.decode(state),
      asset: encoding273_6.decode(state),
      provenance: encoding273_7.decode(state),
      availability: encoding273_8.decode(state),
      verification: encoding273_9.decode(state),
      sourceIndexers: encoding273_10.decode(state)
    }
  }
}

// @peartube/search-index-candidates-request.selector
const encoding274_0 = c.frame(encoding257)

// @peartube/search-index-candidates-request
const encoding274 = {
  preencode(state, m) {
    encoding274_0.preencode(state, m.selector)
    state.end++ // max flag is 2 so always one byte
  ...
  encode(state, m) {
    const flags = (m.limit ? 1 : 0) | (m.cursor ? 2 : 0)

    encoding274_0.encode(state, m.selector)
    c.uint.encode(state, flags)
  ...
  decode(state) {
    const r0 = encoding274_0.decode(state)
    const flags = c.uint.decode(state)
...
const encoding275_1 = c.array(c.frame(encoding273))

// @peartube/search-index-candidates-response
const encoding275 = {
  preencode(state, m) {
    state.end++ // max flag is 32 so always one byte
    encoding275_1.preencode(state, m.candidates)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding275_1.encode(state, m.candidates)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      candidates: encoding275_1.decode(state),
      errorCode: (flags & 2) !== 0 ? c.string.decode(state) : null,
...
const encoding277_1 = c.frame(encoding273)
...
const encoding277 = {
  preencode(state, m) {
    ...
    if (m.candidate) encoding277_1.preencode(state, m.candidate)
    if (m.errorCode) c.string.preencode(state, m.errorCode)
    if (m.errorMessage) c.string.preencode(state, m.errorMessage)
  },
  encode(state, m) {
    ...
    if (m.candidate) encoding277_1.encode(state, m.candidate)
    if (m.errorCode) c.string.encode(state, m.errorCode)
    if (m.errorMessage) c.string.encode(state, m.errorMessage)
  },
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      candidate: (flags & 2) !== 0 ? encoding277_1.decode(state) : null,
      errorCode: (flags & 4) !== 0 ? c.string.decode(state) : null,
...
const encoding286_0 = c.array(c.frame(encoding278))

// @peartube/list-devices-response
const encoding286 = {
  preencode(state, m) {
    encoding286_0.preencode(state, m.devices)
  },
  encode(state, m) {
    encoding286_0.encode(state, m.devices)
  },
  decode(state) {
    const r0 = encoding286_0.decode(state)
...
const encoding293 = {
  preencode(state, m) {
    encoding293_0.preencode(state, m.stats)
  },
  encode(state, m) {
    encoding293_0.encode(state, m.stats)
  },
  decode(state) {
    const r0 = encoding293_0.decode(state)
...
const encoding315_1 = c.array(c.frame(encoding314))

// @peartube/list-comments-response
const encoding315 = {
  preencode(state, m) {
    state.end++ // max flag is 2 so always one byte
    encoding315_1.preencode(state, m.comments)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding315_1.encode(state, m.comments)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      comments: encoding315_1.decode(state),
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding324 = encoding319

// @peartube/get-reactions-request
const encoding325 = encoding323

// @peartube/get-reactions-response.counts
const encoding326_1 = c.array(c.frame(encoding320))

// @peartube/get-reactions-response
const encoding326 = {
  preencode(state, m) {
    state.end++ // max flag is 4 so always one byte
    encoding326_1.preencode(state, m.counts)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding326_1.encode(state, m.counts)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      counts: encoding326_1.decode(state),
...
const encoding337_1 = c.frame(encoding327)
...
const encoding337 = {
  preencode(state, m) {
    ...
    if (m.device) encoding337_1.preencode(state, m.device)
    if (m.error) c.string.preencode(state, m.error)
  },
  encode(state, m) {
    ...
    if (m.device) encoding337_1.encode(state, m.device)
    if (m.error) c.string.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      device: (flags & 2) !== 0 ? encoding337_1.decode(state) : null,
      error: (flags & 4) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding343 = encoding92

// @peartube/cast-pause-request
const encoding344 = encoding0

// @peartube/cast-pause-response
const encoding345 = encoding92

// @peartube/cast-resume-request
const encoding346 = encoding0

// @peartube/cast-resume-response
const encoding347 = encoding92

// @peartube/cast-stop-request
const encoding348 = encoding0

// @peartube/cast-stop-response
const encoding349 = encoding92
...
const encoding353 = encoding92

// @peartube/cast-get-state-request
const encoding354 = encoding0
...
const encoding358_0 = encoding337_1

// @peartube/event-cast-device-found
const encoding358 = {
  preencode(state, m) {
    encoding358_0.preencode(state, m.device)
  },
  encode(state, m) {
    encoding358_0.encode(state, m.device)
  },
  decode(state) {
    const r0 = encoding358_0.decode(state)
...
const encoding363_0 = encoding256_0

// @peartube/search-videos-response
const encoding363 = {
  preencode(state, m) {
    encoding363_0.preencode(state, m.results)
  },
  encode(state, m) {
    encoding363_0.encode(state, m.results)
  },
  decode(state) {
    const r0 = encoding363_0.decode(state)
...
const encoding367 = {
  preencode(state, m) {
    ...
    encoding367_13.preencode(state, m.reasonCodes)
  ...
  encode(state, m) {
    ...
    encoding367_13.encode(state, m.reasonCodes)
  ...
  decode(state) {
    ...
    return {
      ...
      reasonCodes: encoding367_13.decode(state),
      errorCode: (flags & 16) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding370 = encoding0

// @peartube/suspend-network-response
const encoding371 = encoding92

// @peartube/resume-network-request
const encoding372 = encoding0

// @peartube/resume-network-response
const encoding373 = encoding92
...
const encoding377 = {
  preencode(state, m) {
    ...
    if (m.entityKind) c.string.preencode(state, m.entityKind)
  },
  encode(state, m) {
    const flags =
      (m.subtitle ? 1 : 0) |
    ...
    if (m.entityKind) c.string.encode(state, m.entityKind)
  },
  decode(state) {
    const r0 = c.uint.decode(state)
    const r1 = c.string.decode(state)
    ...
    return {
      ...
      entityKind: (flags & 64) !== 0 ? c.string.decode(state) : null
    }
  }
}

// @peartube/provider-search-selector-v1
const encoding378 = {
  preencode(state, m) {
    state.end++ // max flag is 32 so always one byte

    if (m.namespace) c.string.preencode(state, m.namespace)
    if (m.identifier) c.string.preencode(state, m.identifier)
    if (m.title) c.string.preencode(state, m.title)
    c.string.preencode(state, m.kind)
    if (m.year) c.uint.preencode(state, m.year)
    if (m.season) c.uint.preencode(state, m.season)
    if (m.episode) c.uint.preencode(state, m.episode)
  },
  encode(state, m) {
    const flags =
      (m.namespace ? 1 : 0) |
    ...
    if (m.namespace) c.string.encode(state, m.namespace)
    if (m.identifier) c.string.encode(state, m.identifier)
    if (m.title) c.string.encode(state, m.title)
    c.string.encode(state, m.kind)
    if (m.year) c.uint.encode(state, m.year)
    if (m.season) c.uint.encode(state, m.season)
    if (m.episode) c.uint.encode(state, m.episode)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      namespace: (flags & 1) !== 0 ? c.string.decode(state) : null,
      identifier: (flags & 2) !== 0 ? c.string.decode(state) : null,
      title: (flags & 4) !== 0 ? c.string.decode(state) : null,
      kind: c.string.decode(state),
      year: (flags & 8) !== 0 ? c.uint.decode(state) : 0,
      season: (flags & 16) !== 0 ? c.uint.decode(state) : 0,
      episode: (flags & 32) !== 0 ? c.uint.decode(state) : 0
    }
  }
}

// @peartube/provider-search-diagnostics-v1
const encoding379 = {
  preencode(state, m) {
    state.end++ // max flag is 8 so always one byte

    if (m.queriedServices) c.uint.preencode(state, m.queriedServices)
    if (m.respondingServices) c.uint.preencode(state, m.respondingServices)
  },
  encode(state, m) {
    const flags =
      (m.partial ? 1 : 0) |
      (m.stale ? 2 : 0) |
      (m.queriedServices ? 4 : 0) |
      (m.respondingServices ? 8 : 0)

    c.uint.encode(state, flags)

    if (m.queriedServices) c.uint.encode(state, m.queriedServices)
    if (m.respondingServices) c.uint.encode(state, m.respondingServices)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      partial: (flags & 1) !== 0,
      stale: (flags & 2) !== 0,
      queriedServices: (flags & 4) !== 0 ? c.uint.decode(state) : 0,
      respondingServices: (flags & 8) !== 0 ? c.uint.decode(state) : 0
    }
  }
}

// @peartube/provider-search-request.selector
const encoding380_3 = c.frame(encoding378)
...
const encoding380 = {
  preencode(state, m) {
    ...
    if (m.cursor) c.string.preencode(state, m.cursor)
    if (m.limit) c.uint.preencode(state, m.limit)
    if (m.selector) encoding380_3.preencode(state, m.selector)
  },
  encode(state, m) {
    const flags = (m.cursor ? 1 : 0) | (m.limit ? 2 : 0) | (m.selector ? 4 : 0)
    ...
    if (m.cursor) c.string.encode(state, m.cursor)
    if (m.limit) c.uint.encode(state, m.limit)
    if (m.selector) encoding380_3.encode(state, m.selector)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      cursor: (flags & 1) !== 0 ? c.string.decode(state) : null,
      limit: (flags & 2) !== 0 ? c.uint.decode(state) : 0,
      selector: (flags & 4) !== 0 ? encoding380_3.decode(state) : null
    }
  }
}

// @peartube/provider-search-response.hits
const encoding381_1 = c.array(c.frame(encoding377))
// @peartube/provider-search-response.error
const encoding381_3 = c.frame(encoding376)
// @peartube/provider-search-response.diagnostics
const encoding381_4 = c.frame(encoding379)

// @peartube/provider-search-response
const encoding381 = {
  preencode(state, m) {
    state.end++ // max flag is 32 so always one byte
    encoding381_1.preencode(state, m.hits)

    if (m.nextCursor) c.string.preencode(state, m.nextCursor)
    if (m.error) encoding381_3.preencode(state, m.error)
    if (m.diagnostics) encoding381_4.preencode(state, m.diagnostics)
  },
  encode(state, m) {
    const flags =
      (m.success ? 1 : 0) |
    ...
    c.uint.encode(state, flags)
    encoding381_1.encode(state, m.hits)

    if (m.nextCursor) c.string.encode(state, m.nextCursor)
    if (m.error) encoding381_3.encode(state, m.error)
    if (m.diagnostics) encoding381_4.encode(state, m.diagnostics)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      hits: encoding381_1.decode(state),
      nextCursor: (flags & 2) !== 0 ? c.string.decode(state) : null,
      error: (flags & 4) !== 0 ? encoding381_3.decode(state) : null,
      diagnostics: (flags & 8) !== 0 ? encoding381_4.decode(state) : null,
      partial: (flags & 16) !== 0,
      stale: (flags & 32) !== 0
    }
  }
...
const encoding384_1 = c.frame(encoding382)
// @peartube/resolve-provider-ref-response.error
const encoding384_2 = encoding381_3
...
const encoding384 = {
  preencode(state, m) {
    ...
    if (m.resolution) encoding384_1.preencode(state, m.resolution)
    if (m.error) encoding384_2.preencode(state, m.error)
  },
  encode(state, m) {
    ...
    if (m.resolution) encoding384_1.encode(state, m.resolution)
    if (m.error) encoding384_2.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      resolution: (flags & 2) !== 0 ? encoding384_1.decode(state) : null,
      error: (flags & 4) !== 0 ? encoding384_2.decode(state) : null
    }
  }
}
...
const encoding385 = {
  preencode(state, m) {
    ...
    if (m.retentionUntil) c.uint.preencode(state, m.retentionUntil)
    if (m.sourceFileName) c.string.preencode(state, m.sourceFileName)
  },
  encode(state, m) {
    const flags =
      (m.retentionUntil ? 1 : 0) | (m.retentionUntilPresent ? 2 : 0) | (m.sourceFileName ? 4 : 0)
    ...
    if (m.retentionUntil) c.uint.encode(state, m.retentionUntil)
    if (m.sourceFileName) c.string.encode(state, m.sourceFileName)
  },
  decode(state) {
    const r0 = c.uint.decode(state)
    const r1 = c.string.decode(state)
    ...
    return {
      ...
      sourceFileName: (flags & 4) !== 0 ? c.string.decode(state) : null
    }
  }
}

// @peartube/provider-media-context-v1
const encoding386 = {
  preencode(state, m) {
    const flags =
      (m.kind ? 1 : 0) |
  ...
  decode(state) {
    ...
    return {
      kind: (flags & 1) !== 0 ? c.string.decode(state) : null,
      namespace: (flags & 2) !== 0 ? c.string.decode(state) : null,
      identifier: (flags & 4) !== 0 ? c.string.decode(state) : null,
      title: (flags & 8) !== 0 ? c.string.decode(state) : null,
      season: (flags & 16) !== 0 ? c.uint.decode(state) : 0,
      episode: (flags & 32) !== 0 ? c.uint.decode(state) : 0,
      releaseYear: (flags & 64) !== 0 ? c.uint.decode(state) : 0,
      workEntityId: (flags & 128) !== 0 ? c.string.decode(state) : null
    }
  }
}

// @peartube/acquisition-v1.mediaContext
const encoding387_16 = c.frame(encoding386)
...
const encoding387 = {
  preencode(state, m) {
    const flags =
      ...
      (m.recoverable ? 64 : 0) |
      (m.title ? 128 : 0) |
      (m.sourceFileName ? 256 : 0) |
      (m.mediaContext ? 512 : 0)
    ...
    if (m.title) c.string.preencode(state, m.title)
    if (m.sourceFileName) c.string.preencode(state, m.sourceFileName)
    if (m.mediaContext) encoding387_16.preencode(state, m.mediaContext)
  },
  encode(state, m) {
    const flags =
      (m.expectedBytes ? 1 : 0) |
    ...
    if (m.title) c.string.encode(state, m.title)
    if (m.sourceFileName) c.string.encode(state, m.sourceFileName)
    if (m.mediaContext) encoding387_16.encode(state, m.mediaContext)
  },
  decode(state) {
    const r0 = c.uint.decode(state)
    const r1 = c.string.decode(state)
    ...
    return {
      ...
      updatedAt: c.uint.decode(state),
      title: (flags & 128) !== 0 ? c.string.decode(state) : null,
      sourceFileName: (flags & 256) !== 0 ? c.string.decode(state) : null,
      mediaContext: (flags & 512) !== 0 ? encoding387_16.decode(state) : null
    }
  }
}

// @peartube/request-acquisition-request.request
const encoding388_1 = c.frame(encoding385)

// @peartube/request-acquisition-request
const encoding388 = {
  preencode(state, m) {
    c.string.preencode(state, m.idempotencyKey)
    encoding388_1.preencode(state, m.request)
  },
  encode(state, m) {
    c.string.encode(state, m.idempotencyKey)
    encoding388_1.encode(state, m.request)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const r1 = encoding388_1.decode(state)
...
const encoding389_2 = encoding381_3
...
const encoding389 = {
  preencode(state, m) {
    ...
    if (m.acquisition) encoding389_1.preencode(state, m.acquisition)
  ...
  encode(state, m) {
    ...
    if (m.acquisition) encoding389_1.encode(state, m.acquisition)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      acquisition: (flags & 2) !== 0 ? encoding389_1.decode(state) : null,
...
const encoding391_1 = encoding389_1
// @peartube/attach-source-grant-response.error
const encoding391_2 = encoding381_3
...
const encoding391 = {
  preencode(state, m) {
    ...
    if (m.acquisition) encoding391_1.preencode(state, m.acquisition)
    if (m.error) encoding391_2.preencode(state, m.error)
  },
  encode(state, m) {
    const flags = (m.success ? 1 : 0) | (m.acquisition ? 2 : 0) | (m.error ? 4 : 0)
    ...
    if (m.acquisition) encoding391_1.encode(state, m.acquisition)
    if (m.error) encoding391_2.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      acquisition: (flags & 2) !== 0 ? encoding391_1.decode(state) : null,
      error: (flags & 4) !== 0 ? encoding391_2.decode(state) : null
    }
  }
}
...
const encoding393_1 = encoding389_1
// @peartube/get-acquisition-response.error
const encoding393_2 = encoding381_3
...
const encoding394_2 = encoding44_11
...
const encoding394 = {
  preencode(state, m) {
    ...
    if (m.cursor) c.string.preencode(state, m.cursor)
    if (m.limit) c.uint.preencode(state, m.limit)
    if (m.states) encoding394_2.preencode(state, m.states)
  },
  encode(state, m) {
    ...
    if (m.cursor) c.string.encode(state, m.cursor)
    if (m.limit) c.uint.encode(state, m.limit)
    if (m.states) encoding394_2.encode(state, m.states)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      cursor: (flags & 1) !== 0 ? c.string.decode(state) : null,
      limit: (flags & 2) !== 0 ? c.uint.decode(state) : 0,
      states: (flags & 4) !== 0 ? encoding394_2.decode(state) : null
    }
  }
}

// @peartube/list-acquisitions-response.acquisitions
const encoding395_1 = c.array(c.frame(encoding387))
// @peartube/list-acquisitions-response.error
const encoding395_3 = encoding381_3

// @peartube/list-acquisitions-response
const encoding395 = {
  preencode(state, m) {
    state.end++ // max flag is 4 so always one byte
    encoding395_1.preencode(state, m.acquisitions)

    if (m.nextCursor) c.string.preencode(state, m.nextCursor)
    if (m.error) encoding395_3.preencode(state, m.error)
  },
  encode(state, m) {
    const flags = (m.success ? 1 : 0) | (m.nextCursor ? 2 : 0) | (m.error ? 4 : 0)

    c.uint.encode(state, flags)
    encoding395_1.encode(state, m.acquisitions)

    if (m.nextCursor) c.string.encode(state, m.nextCursor)
    if (m.error) encoding395_3.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      acquisitions: encoding395_1.decode(state),
      nextCursor: (flags & 2) !== 0 ? c.string.decode(state) : null,
      error: (flags & 4) !== 0 ? encoding395_3.decode(state) : null
    }
  }
}

// @peartube/cancel-acquisition-request
const encoding396 = encoding392

// @peartube/cancel-acquisition-response.acquisition
const encoding397_1 = encoding389_1
// @peartube/cancel-acquisition-response.error
const encoding397_2 = encoding381_3
...
const encoding398 = encoding392

// @peartube/retry-acquisition-response.acquisition
const encoding399_1 = encoding389_1
// @peartube/retry-acquisition-response.error
const encoding399_2 = encoding381_3
...
const encoding399 = {
  preencode(state, m) {
    ...
    if (m.acquisition) encoding399_1.preencode(state, m.acquisition)
    if (m.error) encoding399_2.preencode(state, m.error)
  },
  encode(state, m) {
    const flags = (m.success ? 1 : 0) | (m.acquisition ? 2 : 0) | (m.error ? 4 : 0)
    ...
    if (m.acquisition) encoding399_1.encode(state, m.acquisition)
    if (m.error) encoding399_2.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      acquisition: (flags & 2) !== 0 ? encoding399_1.decode(state) : null,
      error: (flags & 4) !== 0 ? encoding399_2.decode(state) : null
    }
  }
}
...
const encoding402 = {
  preencode(state, m) {
    ...
    if (m.publication) encoding402_1.preencode(state, m.publication)
    if (m.error) encoding402_2.preencode(state, m.error)
  },
  encode(state, m) {
    ...
    if (m.publication) encoding402_1.encode(state, m.publication)
    if (m.error) encoding402_2.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      publication: (flags & 2) !== 0 ? encoding402_1.decode(state) : null,
      error: (flags & 4) !== 0 ? encoding402_2.decode(state) : null
    }
  }
}
...
const encoding405_1 = c.frame(encoding403)
// @peartube/open-provider-stream-response.error
const encoding405_2 = encoding381_3
...
const encoding405 = {
  preencode(state, m) {
    ...
    if (m.stream) encoding405_1.preencode(state, m.stream)
    if (m.error) encoding405_2.preencode(state, m.error)
  },
  encode(state, m) {
    ...
    if (m.stream) encoding405_1.encode(state, m.stream)
    if (m.error) encoding405_2.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      stream: (flags & 2) !== 0 ? encoding405_1.decode(state) : null,
      error: (flags & 4) !== 0 ? encoding405_2.decode(state) : null
    }
  }
}
...
const encoding407 = encoding0

// @peartube/get-provider-status-response.status
const encoding408_1 = c.frame(encoding406)
// @peartube/get-provider-status-response.error
const encoding408_2 = encoding381_3
...
const encoding408 = {
  preencode(state, m) {
    ...
    if (m.status) encoding408_1.preencode(state, m.status)
    if (m.error) encoding408_2.preencode(state, m.error)
  },
  encode(state, m) {
    const flags = (m.success ? 1 : 0) | (m.status ? 2 : 0) | (m.error ? 4 : 0)
    ...
    if (m.status) encoding408_1.encode(state, m.status)
    if (m.error) encoding408_2.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      status: (flags & 2) !== 0 ? encoding408_1.decode(state) : null,
      error: (flags & 4) !== 0 ? encoding408_2.decode(state) : null
    }
  }
}
...
const encoding410 = encoding0

// @peartube/get-provider-policy-response.policy
const encoding411_1 = c.frame(encoding409)
// @peartube/get-provider-policy-response.error
const encoding411_2 = encoding381_3
...
const encoding411 = {
  preencode(state, m) {
    ...
    if (m.policy) encoding411_1.preencode(state, m.policy)
    if (m.error) encoding411_2.preencode(state, m.error)
  },
  encode(state, m) {
    ...
    if (m.policy) encoding411_1.encode(state, m.policy)
    if (m.error) encoding411_2.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      policy: (flags & 2) !== 0 ? encoding411_1.decode(state) : null,
      error: (flags & 4) !== 0 ? encoding411_2.decode(state) : null
    }
  }
}

// @peartube/set-provider-policy-request.policy
const encoding412_0 = encoding411_1

// @peartube/set-provider-policy-request
const encoding412 = {
  preencode(state, m) {
    encoding412_0.preencode(state, m.policy)
    c.uint.preencode(state, m.expectedRevision)
  },
  encode(state, m) {
    encoding412_0.encode(state, m.policy)
    c.uint.encode(state, m.expectedRevision)
  },
  decode(state) {
    const r0 = encoding412_0.decode(state)
    const r1 = c.uint.decode(state)
...
const encoding413_1 = encoding411_1
// @peartube/set-provider-policy-response.error
const encoding413_2 = encoding381_3
...
const encoding413 = {
  preencode(state, m) {
    ...
    if (m.policy) encoding413_1.preencode(state, m.policy)
    if (m.error) encoding413_2.preencode(state, m.error)
  },
  encode(state, m) {
    const flags = (m.success ? 1 : 0) | (m.policy ? 2 : 0) | (m.error ? 4 : 0)
    ...
    if (m.policy) encoding413_1.encode(state, m.policy)
    if (m.error) encoding413_2.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      policy: (flags & 2) !== 0 ? encoding413_1.decode(state) : null,
      error: (flags & 4) !== 0 ? encoding413_2.decode(state) : null
    }
  }
}

// @peartube/acquisition-policy-v1.allowedPublisherIds
const encoding414_6 = encoding44_11
// @peartube/acquisition-policy-v1.allowedAdapterIds
const encoding414_7 = encoding44_11
...
const encoding414 = {
  preencode(state, m) {
    ...
    encoding414_6.preencode(state, m.allowedPublisherIds)
    encoding414_7.preencode(state, m.allowedAdapterIds)
  ...
  encode(state, m) {
    const flags = (m.enabled ? 1 : 0) | (m.acceptPublicRequests ? 2 : 0)
    ...
    encoding414_6.encode(state, m.allowedPublisherIds)
    encoding414_7.encode(state, m.allowedAdapterIds)
  ...
  decode(state) {
    ...
    return {
      ...
      consentVersion: r2,
      enabled: (flags & 1) !== 0,
      acceptPublicRequests: (flags & 2) !== 0,
      requesterMode: c.string.decode(state),
      allowedPublisherIds: encoding414_6.decode(state),
      allowedAdapterIds: encoding414_7.decode(state),
...
const encoding415 = encoding0

// @peartube/get-acquisition-policy-response.policy
const encoding416_1 = c.frame(encoding414)
// @peartube/get-acquisition-policy-response.error
const encoding416_2 = encoding381_3
...
const encoding416 = {
  preencode(state, m) {
    ...
    if (m.policy) encoding416_1.preencode(state, m.policy)
    if (m.error) encoding416_2.preencode(state, m.error)
  },
  encode(state, m) {
    const flags = (m.success ? 1 : 0) | (m.policy ? 2 : 0) | (m.error ? 4 : 0)
    ...
    if (m.policy) encoding416_1.encode(state, m.policy)
    if (m.error) encoding416_2.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      policy: (flags & 2) !== 0 ? encoding416_1.decode(state) : null,
      error: (flags & 4) !== 0 ? encoding416_2.decode(state) : null
    }
  }
}
...
const encoding418_0 = encoding416_1
// @peartube/set-acquisition-policy-request.consent
const encoding418_2 = c.frame(encoding417)

// @peartube/set-acquisition-policy-request
const encoding418 = {
  preencode(state, m) {
    encoding418_0.preencode(state, m.policy)
    c.uint.preencode(state, m.expectedRevision)
    encoding418_2.preencode(state, m.consent)
  },
  encode(state, m) {
    encoding418_0.encode(state, m.policy)
    c.uint.encode(state, m.expectedRevision)
    encoding418_2.encode(state, m.consent)
  },
  decode(state) {
    const r0 = encoding418_0.decode(state)
    const r1 = c.uint.decode(state)
    const r2 = encoding418_2.decode(state)
...
const encoding419_1 = encoding416_1
// @peartube/set-acquisition-policy-response.error
const encoding419_2 = encoding381_3
...
const encoding419 = {
  preencode(state, m) {
    ...
    if (m.policy) encoding419_1.preencode(state, m.policy)
    if (m.error) encoding419_2.preencode(state, m.error)
  },
  encode(state, m) {
    const flags = (m.success ? 1 : 0) | (m.policy ? 2 : 0) | (m.error ? 4 : 0)
    ...
    if (m.policy) encoding419_1.encode(state, m.policy)
    if (m.error) encoding419_2.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      policy: (flags & 2) !== 0 ? encoding419_1.decode(state) : null,
      error: (flags & 4) !== 0 ? encoding419_2.decode(state) : null
    }
  }
}
...
const encoding293_0 = encoding83_1
...
function getEncoding(name) {
  switch (name) {
    ...
    case '@peartube/provider-search-hit-v1':
      return encoding377
    case '@peartube/provider-search-selector-v1':
      return encoding378
    case '@peartube/provider-search-diagnostics-v1':
      return encoding379
    ...
    case '@peartube/acquisition-request-v1':
      return encoding385
    case '@peartube/provider-media-context-v1':
      return encoding386
