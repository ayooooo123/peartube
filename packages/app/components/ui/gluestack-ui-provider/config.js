...
export const config = {
  ...
  dark: vars({
    "--color-primary-0": "#1A1033",
    "--color-primary-50": "#3B2790",
    "--color-primary-100": "#4C33B8",
    "--color-primary-200": "#5b3fd6",
    "--color-primary-300": "#6D4AE0",
    "--color-primary-400": "#7B5BF5",
    "--color-primary-500": "#7B5BF5",
    "--color-primary-600": "#9B7FF9",
    "--color-primary-700": "#A78BFA",
    "--color-primary-800": "#C4B5FD",
    "--color-primary-900": "#DDD6FE",
    "--color-primary-950": "#EDE9FE",
    /* Secondary  */
