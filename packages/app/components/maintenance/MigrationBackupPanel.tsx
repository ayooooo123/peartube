      ...
      <GlassCard style={styles.card}>
        ...
        {selection ? (
          <View style={styles.confirmBox}>
            ...
            <View style={styles.actionRow}>
              <Pressable onPress={onCancelSelection} disabled={busy === 'restore'} style={styles.secondaryButton} accessibilityRole="button">
                <Text style={styles.secondaryLabel}>Cancel</Text>
              </Pressable>
              <Pressable
                onPress={onRestore}
                disabled={restoreDisabled}
                style={[styles.destructiveButton, restoreDisabled && styles.disabledButton]}
                accessibilityRole="button"
