...
const encoding35 = {
  ...
  decode(state) {
    ...
    return {
      ...
      stats: (flags & 2) !== 0 ? encoding35_1.decode(state) : null,
      warmupStarted: (flags & 4) !== 0,
      peerWarmupStarted: (flags & 8) !== 0,
      selectedBlobWarmup: (flags & 16) !== 0 ? encoding35_4.decode(state) : null,
      peerWarmup: (flags & 32) !== 0 ? encoding35_5.decode(state) : null
    }
  }
}
...
const encoding49_1 = c.frame(encoding48)
...
const encoding49 = {
  preencode(state, m) {
    ...
    if (m.status) encoding49_1.preencode(state, m.status)
    if (m.error) c.string.preencode(state, m.error)
  },
  encode(state, m) {
    ...
    if (m.status) encoding49_1.encode(state, m.status)
    if (m.error) c.string.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      status: (flags & 2) !== 0 ? encoding49_1.decode(state) : null,
...
const encoding50 = encoding43

// @peartube/get-livestream-status-response.status
const encoding51_0 = encoding49_1
...
const encoding51 = {
  preencode(state, m) {
    ...
    if (m.status) encoding51_0.preencode(state, m.status)
    if (m.error) c.string.preencode(state, m.error)
  },
  encode(state, m) {
    ...
    if (m.status) encoding51_0.encode(state, m.status)
    if (m.error) c.string.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      status: (flags & 1) !== 0 ? encoding51_0.decode(state) : null,
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding62 = {
  preencode(state, m) {
    ...
    if (m.subscriptions) encoding62_0.preencode(state, m.subscriptions)
  },
  encode(state, m) {
    ...
    if (m.subscriptions) encoding62_0.encode(state, m.subscriptions)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      subscriptions: (flags & 1) !== 0 ? encoding62_0.decode(state) : null
    }
  }
}
...
const encoding69_0 = c.array(c.frame(encoding63))
...
const encoding69 = {
  preencode(state, m) {
    ...
    if (m.playlists) encoding69_0.preencode(state, m.playlists)
  },
  encode(state, m) {
    ...
    if (m.playlists) encoding69_0.encode(state, m.playlists)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      playlists: (flags & 1) !== 0 ? encoding69_0.decode(state) : null
    }
  }
}
...
const encoding71_0 = c.array(c.frame(encoding64))
...
const encoding71 = {
  preencode(state, m) {
    ...
    if (m.items) encoding71_0.preencode(state, m.items)
  },
  encode(state, m) {
    ...
    if (m.items) encoding71_0.encode(state, m.items)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      items: (flags & 1) !== 0 ? encoding71_0.decode(state) : null
    }
  }
}
...
const encoding85_0 = c.array(c.frame(encoding65))
...
const encoding85 = {
  preencode(state, m) {
    ...
    if (m.entries) encoding85_0.preencode(state, m.entries)
  },
  encode(state, m) {
    ...
    if (m.entries) encoding85_0.encode(state, m.entries)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      entries: (flags & 1) !== 0 ? encoding85_0.decode(state) : null
    }
  }
}
...
const encoding87_1 = c.frame(encoding66)
...
const encoding87 = {
  preencode(state, m) {
    ...
    if (m.resume) encoding87_1.preencode(state, m.resume)
  },
  encode(state, m) {
    ...
    if (m.resume) encoding87_1.encode(state, m.resume)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      found: (flags & 1) !== 0,
      resume: (flags & 2) !== 0 ? encoding87_1.decode(state) : null
    }
  }
}
...
const encoding89_0 = c.array(c.frame(encoding66))
...
const encoding89 = {
  preencode(state, m) {
    ...
    if (m.entries) encoding89_0.preencode(state, m.entries)
  },
  encode(state, m) {
    const flags = m.entries ? 1 : 0
    ...
    if (m.entries) encoding89_0.encode(state, m.entries)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      entries: (flags & 1) !== 0 ? encoding89_0.decode(state) : null
    }
  }
}

// @peartube/set-personal-setting-request
const encoding90 = encoding67

// @peartube/set-personal-setting-response
const encoding91 = encoding13

// @peartube/get-personal-settings-request
const encoding92 = encoding0

// @peartube/get-personal-settings-response.settings
const encoding93_0 = c.array(c.frame(encoding67))
...
const encoding93 = {
  preencode(state, m) {
    ...
    if (m.settings) encoding93_0.preencode(state, m.settings)
  },
  encode(state, m) {
    ...
    if (m.settings) encoding93_0.encode(state, m.settings)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      settings: (flags & 1) !== 0 ? encoding93_0.decode(state) : null
    }
  }
}
...
const encoding100_8 = c.array(c.frame(encoding98))
// @peartube/feed-entry.liveStreams
const encoding100_14 = c.array(c.frame(encoding99))
...
const encoding100 = {
  preencode(state, m) {
    ...
    if (m.previewVideos) encoding100_8.preencode(state, m.previewVideos)
    if (m.driveKey) c.string.preencode(state, m.driveKey)
    if (m.relayRole) c.string.preencode(state, m.relayRole)
    if (m.previewVideosHash) c.string.preencode(state, m.previewVideosHash)
    if (m.liveStreams) encoding100_14.preencode(state, m.liveStreams)
  },
  encode(state, m) {
    const flags =
      (m.publicBeeKey ? 1 : 0) |
    ...
    if (m.previewVideos) encoding100_8.encode(state, m.previewVideos)
    if (m.driveKey) c.string.encode(state, m.driveKey)
    if (m.relayRole) c.string.encode(state, m.relayRole)
    if (m.previewVideosHash) c.string.encode(state, m.previewVideosHash)
    if (m.liveStreams) encoding100_14.encode(state, m.liveStreams)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      previewVideos: (flags & 128) !== 0 ? encoding100_8.decode(state) : null,
      ...
      isLive: (flags & 4096) !== 0,
      liveStreams: (flags & 8192) !== 0 ? encoding100_14.decode(state) : null
    }
  }
}

// @peartube/get-public-feed-request
const encoding101 = encoding84

// @peartube/get-public-feed-response.entries
const encoding102_0 = c.array(c.frame(encoding100))
...
const encoding103 = encoding84

// @peartube/get-canonical-feed-response.entries
const encoding104_3 = encoding102_0
// @peartube/get-canonical-feed-response.videos
const encoding104_4 = encoding100_8
...
const encoding104 = {
  preencode(state, m) {
    ...
    if (m.entries) encoding104_3.preencode(state, m.entries)
    if (m.videos) encoding104_4.preencode(state, m.videos)
  },
  encode(state, m) {
    const flags =
      (m.version ? 1 : 0) |
    ...
    if (m.entries) encoding104_3.encode(state, m.entries)
    if (m.videos) encoding104_4.encode(state, m.videos)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      entries: (flags & 8) !== 0 ? encoding104_3.decode(state) : null,
      videos: (flags & 16) !== 0 ? encoding104_4.decode(state) : null
    }
  }
}
...
const encoding123 = {
  preencode(state, m) {
    ...
    if (m.stats) encoding123_0.preencode(state, m.stats)
  },
  encode(state, m) {
    ...
    if (m.stats) encoding123_0.encode(state, m.stats)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      stats: (flags & 1) !== 0 ? encoding123_0.decode(state) : null
    }
  }
}
...
const encoding127_0 = c.frame(encoding125)

// @peartube/get-seeding-status-response
const encoding127 = {
  preencode(state, m) {
    encoding127_0.preencode(state, m.status)
  },
  encode(state, m) {
    encoding127_0.encode(state, m.status)
  },
  decode(state) {
    const r0 = encoding127_0.decode(state)
...
const encoding128_0 = c.frame(encoding124)

// @peartube/set-seeding-config-request
const encoding128 = {
  preencode(state, m) {
    encoding128_0.preencode(state, m.config)
  },
  encode(state, m) {
    encoding128_0.encode(state, m.config)
  },
  decode(state) {
    const r0 = encoding128_0.decode(state)
...
const encoding131 = encoding0

// @peartube/get-transcode-settings-response.settings
const encoding132_0 = c.frame(encoding130)

// @peartube/get-transcode-settings-response
const encoding132 = {
  preencode(state, m) {
    encoding132_0.preencode(state, m.settings)
  },
  encode(state, m) {
    encoding132_0.encode(state, m.settings)
  },
  decode(state) {
    const r0 = encoding132_0.decode(state)
...
const encoding134_1 = encoding132_0

// @peartube/set-transcode-settings-response
const encoding134 = {
  preencode(state, m) {
    state.end++ // max flag is 2 so always one byte
    encoding134_1.preencode(state, m.settings)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding134_1.encode(state, m.settings)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      settings: encoding134_1.decode(state),
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding140_0 = c.array(c.string)
...
const encoding140 = {
  preencode(state, m) {
    ...
    if (m.channels) encoding140_0.preencode(state, m.channels)
  },
  encode(state, m) {
    ...
    if (m.channels) encoding140_0.encode(state, m.channels)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      channels: (flags & 1) !== 0 ? encoding140_0.decode(state) : null
    }
  }
}
...
const encoding153 = encoding122

// @peartube/get-video-metadata-response.video
const encoding154_0 = encoding38_0

// @peartube/get-video-metadata-response
const encoding154 = {
  preencode(state, m) {
    encoding154_0.preencode(state, m.video)
  },
  encode(state, m) {
    encoding154_0.encode(state, m.video)
  },
  decode(state) {
...
const encoding159_8 = encoding140_0
// @peartube/desktop-browse-video.sections
const encoding159_10 = encoding140_0
...
const encoding159 = {
  preencode(state, m) {
    ...
    if (m.tags) encoding159_8.preencode(state, m.tags)
    if (m.accentHex) c.string.preencode(state, m.accentHex)
    if (m.sections) encoding159_10.preencode(state, m.sections)
    if (m.thumbnailUrl) c.string.preencode(state, m.thumbnailUrl)
    if (m.path) c.string.preencode(state, m.path)
    if (m.blobId) c.string.preencode(state, m.blobId)
    if (m.blobsCoreKey) c.string.preencode(state, m.blobsCoreKey)
  ...
  encode(state, m) {
    ...
    if (m.tags) encoding159_8.encode(state, m.tags)
    if (m.accentHex) c.string.encode(state, m.accentHex)
    if (m.sections) encoding159_10.encode(state, m.sections)
    if (m.thumbnailUrl) c.string.encode(state, m.thumbnailUrl)
    if (m.path) c.string.encode(state, m.path)
    if (m.blobId) c.string.encode(state, m.blobId)
    if (m.blobsCoreKey) c.string.encode(state, m.blobsCoreKey)
  ...
  decode(state) {
    ...
    return {
      ...
      tags: (flags & 8) !== 0 ? encoding159_8.decode(state) : null,
      accentHex: (flags & 16) !== 0 ? c.string.decode(state) : null,
      sections: (flags & 32) !== 0 ? encoding159_10.decode(state) : null,
...
const encoding160_0 = c.array(c.frame(encoding159))
// @peartube/desktop-browse-sections.subscriptions
const encoding160_1 = encoding160_0
// @peartube/desktop-browse-sections.library
const encoding160_2 = encoding160_0
// @peartube/desktop-browse-sections.studio
const encoding160_3 = encoding160_0
// @peartube/desktop-browse-sections.diagnostics
const encoding160_4 = encoding160_0
...
const encoding160 = {
  preencode(state, m) {
    ...
    if (m.home) encoding160_0.preencode(state, m.home)
    if (m.subscriptions) encoding160_1.preencode(state, m.subscriptions)
    if (m.library) encoding160_2.preencode(state, m.library)
    if (m.studio) encoding160_3.preencode(state, m.studio)
    if (m.diagnostics) encoding160_4.preencode(state, m.diagnostics)
  },
  encode(state, m) {
    const flags =
      (m.home ? 1 : 0) |
    ...
    if (m.home) encoding160_0.encode(state, m.home)
    if (m.subscriptions) encoding160_1.encode(state, m.subscriptions)
    if (m.library) encoding160_2.encode(state, m.library)
    if (m.studio) encoding160_3.encode(state, m.studio)
    if (m.diagnostics) encoding160_4.encode(state, m.diagnostics)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      home: (flags & 1) !== 0 ? encoding160_0.decode(state) : null,
      subscriptions: (flags & 2) !== 0 ? encoding160_1.decode(state) : null,
      library: (flags & 4) !== 0 ? encoding160_2.decode(state) : null,
      studio: (flags & 8) !== 0 ? encoding160_3.decode(state) : null,
      diagnostics: (flags & 16) !== 0 ? encoding160_4.decode(state) : null
    }
  }
}
...
const encoding162_0 = encoding140_0
// @peartube/desktop-browse-state.identityChannelKeys
const encoding162_1 = encoding140_0
...
const encoding162 = {
  preencode(state, m) {
    ...
    if (m.subscriptionChannelKeys) encoding162_0.preencode(state, m.subscriptionChannelKeys)
    if (m.identityChannelKeys) encoding162_1.preencode(state, m.identityChannelKeys)
  ...
  encode(state, m) {
    ...
    if (m.subscriptionChannelKeys) encoding162_0.encode(state, m.subscriptionChannelKeys)
    if (m.identityChannelKeys) encoding162_1.encode(state, m.identityChannelKeys)
  ...
  decode(state) {
    ...
    return {
      subscriptionChannelKeys: (flags & 1) !== 0 ? encoding162_0.decode(state) : null,
      identityChannelKeys: (flags & 2) !== 0 ? encoding162_1.decode(state) : null,
...
const encoding163_1 = c.frame(encoding160)
// @peartube/desktop-browse-snapshot.stats
const encoding163_2 = c.frame(encoding161)
// @peartube/desktop-browse-snapshot.state
const encoding163_3 = c.frame(encoding162)
...
const encoding163 = {
  preencode(state, m) {
    ...
    encoding163_1.preencode(state, m.sections)
    encoding163_2.preencode(state, m.stats)
    encoding163_3.preencode(state, m.state)
  },
  encode(state, m) {
    ...
    encoding163_1.encode(state, m.sections)
    encoding163_2.encode(state, m.stats)
    encoding163_3.encode(state, m.state)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      sections: encoding163_1.decode(state),
      stats: encoding163_2.decode(state),
      state: encoding163_3.decode(state)
    }
  }
}
...
const encoding165_5 = c.frame(encoding163)
...
const encoding165 = {
  preencode(state, m) {
    ...
    encoding165_5.preencode(state, m.snapshot)
  },
  encode(state, m) {
    const flags =
    ...
    encoding165_5.encode(state, m.snapshot)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      snapshot: encoding165_5.decode(state)
    }
  }
}
...
const encoding177 = encoding44

// @peartube/transcode-status-request
const encoding178 = encoding176
...
const encoding183_0 = c.frame(encoding181)

// @peartube/get-status-response
const encoding183 = {
  preencode(state, m) {
    encoding183_0.preencode(state, m.status)
  },
  encode(state, m) {
    encoding183_0.encode(state, m.status)
  },
  decode(state) {
    const r0 = encoding183_0.decode(state)
...
const encoding192_0 = c.array(c.frame(encoding190))

// @peartube/global-search-videos-response
const encoding192 = {
  preencode(state, m) {
    encoding192_0.preencode(state, m.results)
  },
  encode(state, m) {
    encoding192_0.encode(state, m.results)
  },
  decode(state) {
    const r0 = encoding192_0.decode(state)
...
const encoding200 = encoding57

// @peartube/list-devices-response.devices
const encoding201_0 = c.array(c.frame(encoding193))

// @peartube/list-devices-response
const encoding201 = {
  preencode(state, m) {
    encoding201_0.preencode(state, m.devices)
  },
  encode(state, m) {
    encoding201_0.encode(state, m.devices)
  },
  decode(state) {
...
const encoding208 = {
  preencode(state, m) {
    encoding208_0.preencode(state, m.stats)
  },
  encode(state, m) {
    encoding208_0.encode(state, m.stats)
  },
  decode(state) {
...
const encoding231_1 = c.array(c.frame(encoding230))

// @peartube/list-comments-response
const encoding231 = {
  preencode(state, m) {
    state.end++ // max flag is 2 so always one byte
    encoding231_1.preencode(state, m.comments)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding231_1.encode(state, m.comments)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      comments: encoding231_1.decode(state),
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding240 = encoding235

// @peartube/get-reactions-request
const encoding241 = encoding239

// @peartube/get-reactions-response.counts
const encoding242_1 = c.array(c.frame(encoding236))

// @peartube/get-reactions-response
const encoding242 = {
  preencode(state, m) {
    state.end++ // max flag is 4 so always one byte
    encoding242_1.preencode(state, m.counts)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding242_1.encode(state, m.counts)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      counts: encoding242_1.decode(state),
...
const encoding253_1 = c.frame(encoding243)
...
const encoding253 = {
  preencode(state, m) {
    ...
    if (m.device) encoding253_1.preencode(state, m.device)
    if (m.error) c.string.preencode(state, m.error)
  },
  encode(state, m) {
    ...
    if (m.device) encoding253_1.encode(state, m.device)
    if (m.error) c.string.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      device: (flags & 2) !== 0 ? encoding253_1.decode(state) : null,
      error: (flags & 4) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding274_0 = encoding253_1

// @peartube/event-cast-device-found
const encoding274 = {
  preencode(state, m) {
    encoding274_0.preencode(state, m.device)
  },
  encode(state, m) {
    encoding274_0.encode(state, m.device)
  },
  decode(state) {
...
const encoding279_0 = encoding192_0

// @peartube/search-videos-response
const encoding279 = {
  preencode(state, m) {
    encoding279_0.preencode(state, m.results)
  },
  encode(state, m) {
    encoding279_0.encode(state, m.results)
  },
  decode(state) {
...
const encoding281 = encoding44

// @peartube/index-video-vectors-request
const encoding282 = encoding122

// @peartube/index-video-vectors-response
const encoding283 = encoding44
...
const encoding286_1 = c.array(c.frame(encoding284))

// @peartube/get-recommendations-response
const encoding286 = {
  preencode(state, m) {
    state.end++ // max flag is 2 so always one byte
    encoding286_1.preencode(state, m.recommendations)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding286_1.encode(state, m.recommendations)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      recommendations: encoding286_1.decode(state),
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding288_1 = encoding286_1

// @peartube/get-video-recommendations-response
const encoding288 = {
  preencode(state, m) {
    state.end++ // max flag is 2 so always one byte
    encoding288_1.preencode(state, m.recommendations)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding288_1.encode(state, m.recommendations)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      recommendations: encoding288_1.decode(state),
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding289 = {
  preencode(state, m) {
    ...
    if (version >= 2 && m.label) c.string.preencode(state, m.label)
    if (version >= 2 && m.addedAt) c.uint.preencode(state, m.addedAt)
  },
  encode(state, m) {
    const flags = ((version >= 2 && m.label) ? 1 : 0) | ((version >= 2 && m.addedAt) ? 2 : 0)

    c.string.encode(state, m.mirrorKey)
    c.uint.encode(state, flags)

    if (version >= 2 && m.label) c.string.encode(state, m.label)
    if (version >= 2 && m.addedAt) c.uint.encode(state, m.addedAt)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const flags = c.uint.decode(state)
    ...
    return {
      mirrorKey: r0,
      label: (version >= 2 && (flags & 1) !== 0) ? c.string.decode(state) : null,
      addedAt: (version >= 2 && (flags & 2) !== 0) ? c.uint.decode(state) : 0
    }
  }
}
...
const encoding290 = {
  ...
  encode(state, m) {
    const flags = (version >= 2 && m.label) ? 1 : 0
...
const encoding291 = {
  preencode(state, m) {
    ...
    if (version >= 2 && m.mirrorKey) c.string.preencode(state, m.mirrorKey)
    if (version >= 2 && m.label) c.string.preencode(state, m.label)
  },
  encode(state, m) {
    const flags =
      ((version >= 2 && m.success) ? 1 : 0) |
      ((version >= 2 && m.mirrorKey) ? 2 : 0) |
      ((version >= 2 && m.label) ? 4 : 0)

    c.uint.encode(state, flags)

    if (version >= 2 && m.mirrorKey) c.string.encode(state, m.mirrorKey)
    if (version >= 2 && m.label) c.string.encode(state, m.label)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      mirrorKey: (version >= 2 && (flags & 2) !== 0) ? c.string.decode(state) : null,
      label: (version >= 2 && (flags & 4) !== 0) ? c.string.decode(state) : null
    }
  }
}
...
const encoding293 = {
  ...
  encode(state, m) {
    const flags = (version >= 2 && m.success) ? 1 : 0
...
const encoding295_0 = c.array(c.frame(encoding289))
...
const encoding295 = {
  preencode(state, m) {
    ...
    if (version >= 2 && m.links) encoding295_0.preencode(state, m.links)
  },
  encode(state, m) {
    const flags = (version >= 2 && m.links) ? 1 : 0

    c.uint.encode(state, flags)

    if (version >= 2 && m.links) encoding295_0.encode(state, m.links)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      links: (version >= 2 && (flags & 1) !== 0) ? encoding295_0.decode(state) : null
    }
  }
}

// @peartube/prepare-playback-response.stats, deferred due to recusive use
const encoding35_1 = c.frame(encoding121)
...
const encoding123_0 = encoding35_1
// @peartube/event-video-stats.stats, deferred due to recusive use
const encoding208_0 = encoding35_1
