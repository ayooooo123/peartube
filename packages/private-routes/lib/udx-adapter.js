...
export const UDX_LINK_DESTROY_CIRCUIT = Symbol('udx-link-destroy-circuit')
export const UDX_SEND_CELL = Symbol('udx-send-cell')
export const UDX_TRY_SEND_CELL = Symbol('udx-try-send-cell')
...
export const UDX_ENDPOINT_RESERVATION_STATS = Symbol('udx-endpoint-reservation-stats')
export const TEST_ONLY_UDX_STREAM_COUNTER = Symbol('test-only-udx-stream-counter')
