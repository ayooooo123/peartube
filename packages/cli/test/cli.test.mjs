...
test('package.json defines standalone relay build scripts', async (t) => {
  ...
  t.is(pkg.scripts['test'], 'brittle test/admission.test.mjs test/archive-console-creators.test.mjs test/archive-ui.test.mjs test/archive.test.mjs test/blob-downloader.test.mjs test/classification.test.mjs test/cli.test.mjs test/config.test.mjs test/creators.test.mjs test/local-drive-mirror.test.mjs test/relay-seeding.test.mjs test/service.test.mjs test/status.test.mjs')
