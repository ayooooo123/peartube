...
const encoding147 = {
  preencode(state, m) {
    ...
    if (m.thumbnailBlobId) c.string.preencode(state, m.thumbnailBlobId)
    if (m.thumbnailBlobsCoreKey) c.string.preencode(state, m.thumbnailBlobsCoreKey)
    if (version >= 2 && m.thumbnailMimeType) c.string.preencode(state, m.thumbnailMimeType)
  },
  encode(state, m) {
    const flags =
      (m.thumbnailBlobId ? 1 : 0) |
      (m.thumbnailBlobsCoreKey ? 2 : 0) |
      ((version >= 2 && m.thumbnailMimeType) ? 4 : 0)
    ...
    if (m.thumbnailBlobId) c.string.encode(state, m.thumbnailBlobId)
    if (m.thumbnailBlobsCoreKey) c.string.encode(state, m.thumbnailBlobsCoreKey)
    if (version >= 2 && m.thumbnailMimeType) c.string.encode(state, m.thumbnailMimeType)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const r1 = c.string.decode(state)
    ...
    return {
      ...
      thumbnailMimeType: (version >= 2 && (flags & 4) !== 0) ? c.string.decode(state) : null
    }
  }
}
...
const encoding150_0 = encoding38_0

// @peartube/get-video-metadata-response
const encoding150 = {
  preencode(state, m) {
    encoding150_0.preencode(state, m.video)
  },
  encode(state, m) {
    encoding150_0.encode(state, m.video)
  },
  decode(state) {
    const r0 = encoding150_0.decode(state)
...
const encoding154 = encoding13

// @peartube/desktop-browse-video.tags
const encoding155_8 = encoding140_0
// @peartube/desktop-browse-video.sections
const encoding155_10 = encoding140_0
...
const encoding155 = {
  preencode(state, m) {
    ...
    if (m.tags) encoding155_8.preencode(state, m.tags)
    if (m.accentHex) c.string.preencode(state, m.accentHex)
    if (m.sections) encoding155_10.preencode(state, m.sections)
    if (m.thumbnailUrl) c.string.preencode(state, m.thumbnailUrl)
    if (m.path) c.string.preencode(state, m.path)
    if (m.blobId) c.string.preencode(state, m.blobId)
    if (m.blobsCoreKey) c.string.preencode(state, m.blobsCoreKey)
  ...
  encode(state, m) {
    ...
    if (m.tags) encoding155_8.encode(state, m.tags)
    if (m.accentHex) c.string.encode(state, m.accentHex)
    if (m.sections) encoding155_10.encode(state, m.sections)
    if (m.thumbnailUrl) c.string.encode(state, m.thumbnailUrl)
    if (m.path) c.string.encode(state, m.path)
    if (m.blobId) c.string.encode(state, m.blobId)
    if (m.blobsCoreKey) c.string.encode(state, m.blobsCoreKey)
  ...
  decode(state) {
    ...
    return {
      ...
      tags: (flags & 8) !== 0 ? encoding155_8.decode(state) : null,
      accentHex: (flags & 16) !== 0 ? c.string.decode(state) : null,
      sections: (flags & 32) !== 0 ? encoding155_10.decode(state) : null,
...
const encoding156_0 = c.array(c.frame(encoding155))
// @peartube/desktop-browse-sections.subscriptions
const encoding156_1 = encoding156_0
// @peartube/desktop-browse-sections.library
const encoding156_2 = encoding156_0
// @peartube/desktop-browse-sections.studio
const encoding156_3 = encoding156_0
// @peartube/desktop-browse-sections.diagnostics
const encoding156_4 = encoding156_0
...
const encoding156 = {
  preencode(state, m) {
    ...
    if (m.home) encoding156_0.preencode(state, m.home)
    if (m.subscriptions) encoding156_1.preencode(state, m.subscriptions)
    if (m.library) encoding156_2.preencode(state, m.library)
    if (m.studio) encoding156_3.preencode(state, m.studio)
    if (m.diagnostics) encoding156_4.preencode(state, m.diagnostics)
  },
  encode(state, m) {
    const flags =
      (m.home ? 1 : 0) |
    ...
    if (m.home) encoding156_0.encode(state, m.home)
    if (m.subscriptions) encoding156_1.encode(state, m.subscriptions)
    if (m.library) encoding156_2.encode(state, m.library)
    if (m.studio) encoding156_3.encode(state, m.studio)
    if (m.diagnostics) encoding156_4.encode(state, m.diagnostics)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      home: (flags & 1) !== 0 ? encoding156_0.decode(state) : null,
      subscriptions: (flags & 2) !== 0 ? encoding156_1.decode(state) : null,
      library: (flags & 4) !== 0 ? encoding156_2.decode(state) : null,
      studio: (flags & 8) !== 0 ? encoding156_3.decode(state) : null,
      diagnostics: (flags & 16) !== 0 ? encoding156_4.decode(state) : null
    }
  }
}
...
const encoding158_0 = encoding140_0
// @peartube/desktop-browse-state.identityChannelKeys
const encoding158_1 = encoding140_0
...
const encoding158 = {
  preencode(state, m) {
    ...
    if (m.subscriptionChannelKeys) encoding158_0.preencode(state, m.subscriptionChannelKeys)
    if (m.identityChannelKeys) encoding158_1.preencode(state, m.identityChannelKeys)
  ...
  encode(state, m) {
    ...
    if (m.subscriptionChannelKeys) encoding158_0.encode(state, m.subscriptionChannelKeys)
    if (m.identityChannelKeys) encoding158_1.encode(state, m.identityChannelKeys)
  ...
  decode(state) {
    ...
    return {
      subscriptionChannelKeys: (flags & 1) !== 0 ? encoding158_0.decode(state) : null,
      identityChannelKeys: (flags & 2) !== 0 ? encoding158_1.decode(state) : null,
...
const encoding159_1 = c.frame(encoding156)
// @peartube/desktop-browse-snapshot.stats
const encoding159_2 = c.frame(encoding157)
// @peartube/desktop-browse-snapshot.state
const encoding159_3 = c.frame(encoding158)
...
const encoding159 = {
  preencode(state, m) {
    ...
    encoding159_1.preencode(state, m.sections)
    encoding159_2.preencode(state, m.stats)
    encoding159_3.preencode(state, m.state)
  },
  encode(state, m) {
    ...
    encoding159_1.encode(state, m.sections)
    encoding159_2.encode(state, m.stats)
    encoding159_3.encode(state, m.state)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      sections: encoding159_1.decode(state),
      stats: encoding159_2.decode(state),
      state: encoding159_3.decode(state)
    }
  }
}
...
const encoding161_5 = c.frame(encoding159)
...
const encoding161 = {
  preencode(state, m) {
    ...
    encoding161_5.preencode(state, m.snapshot)
  },
  encode(state, m) {
    const flags =
    ...
    encoding161_5.encode(state, m.snapshot)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      snapshot: encoding161_5.decode(state)
    }
  }
}
...
const encoding165_0 = encoding161_5

// @peartube/desktop-refresh-browse-response
const encoding165 = {
  preencode(state, m) {
    encoding165_0.preencode(state, m.snapshot)
  },
  encode(state, m) {
    encoding165_0.encode(state, m.snapshot)
  },
  decode(state) {
...
const encoding179_0 = c.frame(encoding177)

// @peartube/get-status-response
const encoding179 = {
  preencode(state, m) {
    encoding179_0.preencode(state, m.status)
  },
  encode(state, m) {
    encoding179_0.encode(state, m.status)
  },
  decode(state) {
    const r0 = encoding179_0.decode(state)
...
const encoding188_0 = c.array(c.frame(encoding186))

// @peartube/global-search-videos-response
const encoding188 = {
  preencode(state, m) {
    encoding188_0.preencode(state, m.results)
  },
  encode(state, m) {
    encoding188_0.encode(state, m.results)
  },
  decode(state) {
    const r0 = encoding188_0.decode(state)
...
const encoding196 = encoding57

// @peartube/list-devices-response.devices
const encoding197_0 = c.array(c.frame(encoding189))

// @peartube/list-devices-response
const encoding197 = {
  preencode(state, m) {
    encoding197_0.preencode(state, m.devices)
  },
  encode(state, m) {
    encoding197_0.encode(state, m.devices)
  },
  decode(state) {
    const r0 = encoding197_0.decode(state)
...
const encoding204 = {
  preencode(state, m) {
    encoding204_0.preencode(state, m.stats)
  },
  encode(state, m) {
    encoding204_0.encode(state, m.stats)
  },
  decode(state) {
...
const encoding227_1 = c.array(c.frame(encoding226))

// @peartube/list-comments-response
const encoding227 = {
  preencode(state, m) {
    state.end++ // max flag is 2 so always one byte
    encoding227_1.preencode(state, m.comments)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding227_1.encode(state, m.comments)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      comments: encoding227_1.decode(state),
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding238 = {
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding238_1.encode(state, m.counts)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      counts: encoding238_1.decode(state),
...
const encoding249_1 = c.frame(encoding239)
...
const encoding249 = {
  preencode(state, m) {
    ...
    if (m.device) encoding249_1.preencode(state, m.device)
    if (m.error) c.string.preencode(state, m.error)
  },
  encode(state, m) {
    ...
    if (m.device) encoding249_1.encode(state, m.device)
    if (m.error) c.string.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      device: (flags & 2) !== 0 ? encoding249_1.decode(state) : null,
      error: (flags & 4) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding270_0 = encoding249_1

// @peartube/event-cast-device-found
const encoding270 = {
  preencode(state, m) {
    encoding270_0.preencode(state, m.device)
  },
  encode(state, m) {
    encoding270_0.encode(state, m.device)
  },
  decode(state) {
    const r0 = encoding270_0.decode(state)
...
const encoding275_0 = encoding188_0

// @peartube/search-videos-response
const encoding275 = {
  preencode(state, m) {
    encoding275_0.preencode(state, m.results)
  },
  encode(state, m) {
    encoding275_0.encode(state, m.results)
  },
  decode(state) {
    const r0 = encoding275_0.decode(state)
...
const encoding277 = encoding44

// @peartube/index-video-vectors-request
const encoding278 = encoding122

// @peartube/index-video-vectors-response
const encoding279 = encoding44
...
const encoding282_1 = c.array(c.frame(encoding280))

// @peartube/get-recommendations-response
const encoding282 = {
  preencode(state, m) {
    state.end++ // max flag is 2 so always one byte
    encoding282_1.preencode(state, m.recommendations)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding282_1.encode(state, m.recommendations)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      recommendations: encoding282_1.decode(state),
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding284_1 = encoding282_1

// @peartube/get-video-recommendations-response
const encoding284 = {
  preencode(state, m) {
    state.end++ // max flag is 2 so always one byte
    encoding284_1.preencode(state, m.recommendations)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding284_1.encode(state, m.recommendations)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      recommendations: encoding284_1.decode(state),
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding286 = {
  preencode(state, m) {
    ...
    if (version >= 3 && m.fullCopyPeers) c.uint.preencode(state, m.fullCopyPeers)
    if (version >= 3 && m.byteLength) c.uint.preencode(state, m.byteLength)
    if (version >= 3 && m.reason) c.string.preencode(state, m.reason)
  },
  encode(state, m) {
    const flags =
      ((version >= 3 && m.eligible) ? 1 : 0) |
      ((version >= 3 && m.fullCopyPeers) ? 2 : 0) |
      ((version >= 3 && m.relayHasFullCopy) ? 4 : 0) |
      ((version >= 3 && m.ownDeviceHasFullCopy) ? 8 : 0) |
      ((version >= 3 && m.byteLength) ? 16 : 0) |
      ((version >= 3 && m.reason) ? 32 : 0)

    c.uint.encode(state, flags)

    if (version >= 3 && m.fullCopyPeers) c.uint.encode(state, m.fullCopyPeers)
    if (version >= 3 && m.byteLength) c.uint.encode(state, m.byteLength)
  ...
  decode(state) {
    ...
    return {
      eligible: (version >= 3 && (flags & 1) !== 0),
      fullCopyPeers: (version >= 3 && (flags & 2) !== 0) ? c.uint.decode(state) : 0,
      relayHasFullCopy: (version >= 3 && (flags & 4) !== 0),
      ownDeviceHasFullCopy: (version >= 3 && (flags & 8) !== 0),
      byteLength: (version >= 3 && (flags & 16) !== 0) ? c.uint.decode(state) : 0,
      reason: (version >= 3 && (flags & 32) !== 0) ? c.string.decode(state) : null
    }
  }
}

// @peartube/offload-upload-request
const encoding287 = encoding122
...
const encoding288 = {
  preencode(state, m) {
    ...
    if (version >= 3 && m.freedBytes) c.uint.preencode(state, m.freedBytes)
    if (version >= 3 && m.reason) c.string.preencode(state, m.reason)
  },
  encode(state, m) {
    const flags =
      ((version >= 3 && m.success) ? 1 : 0) |
      ((version >= 3 && m.freedBytes) ? 2 : 0) |
      ((version >= 3 && m.reason) ? 4 : 0)

    c.uint.encode(state, flags)

    if (version >= 3 && m.freedBytes) c.uint.encode(state, m.freedBytes)
    if (version >= 3 && m.reason) c.string.encode(state, m.reason)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      freedBytes: (version >= 3 && (flags & 2) !== 0) ? c.uint.decode(state) : 0,
      reason: (version >= 3 && (flags & 4) !== 0) ? c.string.decode(state) : null
    }
  }
}
...
const encoding204_0 = encoding35_1
