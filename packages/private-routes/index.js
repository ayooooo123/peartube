...
export { RouteExtensionSession } from './lib/route-extension.js'
...
export {
  ...
  DEFAULT_MAX_COMPILED_DATAGRAMS,
  DEFAULT_MAX_COMPILED_QUEUED_BYTES,
  DEFAULT_MAX_COMPILED_QUEUED_FRAGMENTS,
  DEFAULT_MAX_COMPILED_READ_BYTES,
  DEFAULT_MAX_COMPILED_READ_FRAGMENTS,
  MAX_COMPILED_STREAM_FRAGMENTS,
  MAX_COMPILED_STREAM_WRITE,
