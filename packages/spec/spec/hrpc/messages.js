...
const encoding212 = {
  preencode(state, m) {
    const flags =
      ...
      ((version >= 8 && m.availability) ? 8192 : 0)
    ...
    if (version >= 8 && m.availability) c.string.preencode(state, m.availability)
  },
  encode(state, m) {
    const flags =
      ((version >= 3 && m.title) ? 1 : 0) |
    ...
    if (version >= 8 && m.availability) c.string.encode(state, m.availability)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      availability: (version >= 8 && (flags & 8192) !== 0) ? c.string.decode(state) : null
    }
  }
}
