...
const encoding29_11 = c.array(c.frame(encoding28))
// @peartube/channel-catalog-profile.artwork
const encoding29_12 = c.array(c.frame(encoding27))
...
const encoding29 = {
  preencode(state, m) {
    ...
    if (m.sources) encoding29_11.preencode(state, m.sources)
    if (m.artwork) encoding29_12.preencode(state, m.artwork)
  },
  encode(state, m) {
    const flags =
      (m.description ? 1 : 0) |
    ...
    if (m.sources) encoding29_11.encode(state, m.sources)
    if (m.artwork) encoding29_12.encode(state, m.artwork)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const r1 = c.string.decode(state)
    ...
    return {
      ...
      sources: (flags & 512) !== 0 ? encoding29_11.decode(state) : null,
      artwork: (flags & 1024) !== 0 ? encoding29_12.decode(state) : null
    }
  }
}
...
const encoding33_3 = c.frame(encoding29)
// @peartube/get-content-catalog-response.groups
const encoding33_4 = c.array(c.frame(encoding30))
...
const encoding33 = {
  preencode(state, m) {
    ...
    if (m.profile) encoding33_3.preencode(state, m.profile)
    if (m.groups) encoding33_4.preencode(state, m.groups)
  },
  encode(state, m) {
    const flags =
      (m.success ? 1 : 0) |
    ...
    if (m.profile) encoding33_3.encode(state, m.profile)
    if (m.groups) encoding33_4.encode(state, m.groups)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      profile: (flags & 8) !== 0 ? encoding33_3.decode(state) : null,
      groups: (flags & 16) !== 0 ? encoding33_4.decode(state) : null
    }
  }
}
...
const encoding34 = {
  ...
  decode(state) {
    ...
    return {
      ...
      limitProvided: (version >= 2 && (flags & 8) !== 0)
    }
  }
}

// @peartube/get-content-items-response.group
const encoding35_3 = c.frame(encoding30)
// @peartube/get-content-items-response.items
const encoding35_4 = c.array(c.frame(encoding31))
...
const encoding35 = {
  preencode(state, m) {
    ...
    if (m.errorCode) c.string.preencode(state, m.errorCode)
    if (m.error) c.string.preencode(state, m.error)
    if (m.group) encoding35_3.preencode(state, m.group)
    if (m.items) encoding35_4.preencode(state, m.items)
  ...
  encode(state, m) {
    ...
    if (m.errorCode) c.string.encode(state, m.errorCode)
    if (m.error) c.string.encode(state, m.error)
    if (m.group) encoding35_3.encode(state, m.group)
    if (m.items) encoding35_4.encode(state, m.items)
  ...
  decode(state) {
    ...
    return {
      ...
      errorCode: (flags & 2) !== 0 ? c.string.decode(state) : null,
      error: (flags & 4) !== 0 ? c.string.decode(state) : null,
      group: (flags & 8) !== 0 ? encoding35_3.decode(state) : null,
      items: (flags & 16) !== 0 ? encoding35_4.decode(state) : null,
...
const encoding38 = {
  preencode(state, m) {
    ...
    if (m.videos) encoding38_0.preencode(state, m.videos)
  },
  encode(state, m) {
    ...
    if (m.videos) encoding38_0.encode(state, m.videos)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      videos: (flags & 1) !== 0 ? encoding38_0.decode(state) : null
    }
  }
}
...
const encoding44_4 = c.frame(encoding42)
// @peartube/prepare-playback-response.peerWarmup
const encoding44_5 = c.frame(encoding43)
...
const encoding44 = {
  preencode(state, m) {
    ...
    if (m.stats) encoding44_1.preencode(state, m.stats)
    if (m.selectedBlobWarmup) encoding44_4.preencode(state, m.selectedBlobWarmup)
    if (m.peerWarmup) encoding44_5.preencode(state, m.peerWarmup)
  },
  encode(state, m) {
    const flags =
      (m.url ? 1 : 0) |
    ...
    if (m.stats) encoding44_1.encode(state, m.stats)
    if (m.selectedBlobWarmup) encoding44_4.encode(state, m.selectedBlobWarmup)
    if (m.peerWarmup) encoding44_5.encode(state, m.peerWarmup)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      stats: (flags & 2) !== 0 ? encoding44_1.decode(state) : null,
      warmupStarted: (flags & 4) !== 0,
      peerWarmupStarted: (flags & 8) !== 0,
      selectedBlobWarmup: (flags & 16) !== 0 ? encoding44_4.decode(state) : null,
      peerWarmup: (flags & 32) !== 0 ? encoding44_5.decode(state) : null
    }
  }
}

// @peartube/web-prepare-playback-response.selectedBlobWarmup
const encoding45_8 = encoding44_4
// @peartube/web-prepare-playback-response.peerWarmup
const encoding45_9 = encoding44_5
...
const encoding45 = {
  preencode(state, m) {
    ...
    if (m.stats) encoding45_5.preencode(state, m.stats)
    if (m.selectedBlobWarmup) encoding45_8.preencode(state, m.selectedBlobWarmup)
    if (m.peerWarmup) encoding45_9.preencode(state, m.peerWarmup)
  },
  encode(state, m) {
    const flags =
      (m.transcoded ? 1 : 0) |
    ...
    if (m.stats) encoding45_5.encode(state, m.stats)
    if (m.selectedBlobWarmup) encoding45_8.encode(state, m.selectedBlobWarmup)
    if (m.peerWarmup) encoding45_9.encode(state, m.peerWarmup)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      stats: (flags & 16) !== 0 ? encoding45_5.decode(state) : null,
      warmupStarted: (flags & 32) !== 0,
      peerWarmupStarted: (flags & 64) !== 0,
      selectedBlobWarmup: (flags & 128) !== 0 ? encoding45_8.decode(state) : null,
      peerWarmup: (flags & 256) !== 0 ? encoding45_9.decode(state) : null
    }
  }
}
...
const encoding47_0 = c.frame(encoding36)

// @peartube/get-video-data-response
const encoding47 = {
  preencode(state, m) {
    encoding47_0.preencode(state, m.video)
  },
  encode(state, m) {
    encoding47_0.encode(state, m.video)
  },
  decode(state) {
    const r0 = encoding47_0.decode(state)
...
const encoding49_0 = encoding47_0

// @peartube/upload-video-response
const encoding49 = {
  preencode(state, m) {
    encoding49_0.preencode(state, m.video)
  },
  encode(state, m) {
    encoding49_0.encode(state, m.video)
  },
  decode(state) {
    const r0 = encoding49_0.decode(state)
...
const encoding58_1 = c.frame(encoding57)
...
const encoding58 = {
  preencode(state, m) {
    ...
    if (m.status) encoding58_1.preencode(state, m.status)
    if (m.error) c.string.preencode(state, m.error)
  },
  encode(state, m) {
    ...
    if (m.status) encoding58_1.encode(state, m.status)
    if (m.error) c.string.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      status: (flags & 2) !== 0 ? encoding58_1.decode(state) : null,
      error: (flags & 4) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding59 = encoding52

// @peartube/get-livestream-status-response.status
const encoding60_0 = encoding58_1
...
const encoding60 = {
  preencode(state, m) {
    ...
    if (m.status) encoding60_0.preencode(state, m.status)
    if (m.error) c.string.preencode(state, m.error)
  },
  encode(state, m) {
    ...
    if (m.status) encoding60_0.encode(state, m.status)
    if (m.error) c.string.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      status: (flags & 1) !== 0 ? encoding60_0.decode(state) : null,
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding71 = {
  preencode(state, m) {
    ...
    if (m.subscriptions) encoding71_0.preencode(state, m.subscriptions)
  },
  encode(state, m) {
    ...
    if (m.subscriptions) encoding71_0.encode(state, m.subscriptions)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      subscriptions: (flags & 1) !== 0 ? encoding71_0.decode(state) : null
    }
  }
}
...
const encoding78_0 = c.array(c.frame(encoding72))
...
const encoding78 = {
  preencode(state, m) {
    ...
    if (m.playlists) encoding78_0.preencode(state, m.playlists)
  },
  encode(state, m) {
    ...
    if (m.playlists) encoding78_0.encode(state, m.playlists)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      playlists: (flags & 1) !== 0 ? encoding78_0.decode(state) : null
    }
  }
}
...
const encoding80_0 = c.array(c.frame(encoding73))
...
const encoding80 = {
  preencode(state, m) {
    ...
    if (m.items) encoding80_0.preencode(state, m.items)
  },
  encode(state, m) {
    ...
    if (m.items) encoding80_0.encode(state, m.items)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      items: (flags & 1) !== 0 ? encoding80_0.decode(state) : null
    }
  }
}
...
const encoding94_0 = c.array(c.frame(encoding74))
...
const encoding94 = {
  preencode(state, m) {
    ...
    if (m.entries) encoding94_0.preencode(state, m.entries)
  },
  encode(state, m) {
    ...
    if (m.entries) encoding94_0.encode(state, m.entries)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      entries: (flags & 1) !== 0 ? encoding94_0.decode(state) : null
    }
  }
}
...
const encoding96_1 = c.frame(encoding75)
...
const encoding96 = {
  preencode(state, m) {
    ...
    if (m.resume) encoding96_1.preencode(state, m.resume)
  },
  encode(state, m) {
    ...
    if (m.resume) encoding96_1.encode(state, m.resume)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      found: (flags & 1) !== 0,
      resume: (flags & 2) !== 0 ? encoding96_1.decode(state) : null
    }
  }
}
...
const encoding98_0 = c.array(c.frame(encoding75))
...
const encoding102_0 = c.array(c.frame(encoding76))
...
const encoding102 = {
  preencode(state, m) {
    ...
    if (m.settings) encoding102_0.preencode(state, m.settings)
  },
  encode(state, m) {
    ...
    if (m.settings) encoding102_0.encode(state, m.settings)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      settings: (flags & 1) !== 0 ? encoding102_0.decode(state) : null
    }
  }
}
...
const encoding109_8 = c.array(c.frame(encoding107))
// @peartube/feed-entry.liveStreams
const encoding109_14 = c.array(c.frame(encoding108))
...
const encoding109 = {
  preencode(state, m) {
    ...
    if (m.previewVideos) encoding109_8.preencode(state, m.previewVideos)
    if (m.driveKey) c.string.preencode(state, m.driveKey)
    if (m.relayRole) c.string.preencode(state, m.relayRole)
    if (m.previewVideosHash) c.string.preencode(state, m.previewVideosHash)
    if (m.liveStreams) encoding109_14.preencode(state, m.liveStreams)
  },
  encode(state, m) {
    const flags =
      (m.publicBeeKey ? 1 : 0) |
    ...
    if (m.previewVideos) encoding109_8.encode(state, m.previewVideos)
    if (m.driveKey) c.string.encode(state, m.driveKey)
    if (m.relayRole) c.string.encode(state, m.relayRole)
    if (m.previewVideosHash) c.string.encode(state, m.previewVideosHash)
    if (m.liveStreams) encoding109_14.encode(state, m.liveStreams)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      previewVideos: (flags & 128) !== 0 ? encoding109_8.decode(state) : null,
      ...
      isLive: (flags & 4096) !== 0,
      liveStreams: (flags & 8192) !== 0 ? encoding109_14.decode(state) : null
    }
  }
}

// @peartube/get-public-feed-request
const encoding110 = encoding93

// @peartube/get-public-feed-response.entries
const encoding111_0 = c.array(c.frame(encoding109))
...
const encoding111 = {
  preencode(state, m) {
    ...
    if (m.entries) encoding111_0.preencode(state, m.entries)
  },
  encode(state, m) {
    const flags = m.entries ? 1 : 0
    ...
    if (m.entries) encoding111_0.encode(state, m.entries)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      entries: (flags & 1) !== 0 ? encoding111_0.decode(state) : null
    }
  }
}

// @peartube/get-canonical-feed-request
const encoding112 = encoding93

// @peartube/get-canonical-feed-response.entries
const encoding113_3 = encoding111_0
// @peartube/get-canonical-feed-response.videos
const encoding113_4 = encoding109_8
...
const encoding113 = {
  preencode(state, m) {
    ...
    if (m.entries) encoding113_3.preencode(state, m.entries)
    if (m.videos) encoding113_4.preencode(state, m.videos)
  },
  encode(state, m) {
    const flags =
      (m.version ? 1 : 0) |
    ...
    if (m.entries) encoding113_3.encode(state, m.entries)
    if (m.videos) encoding113_4.encode(state, m.videos)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      entries: (flags & 8) !== 0 ? encoding113_3.decode(state) : null,
      videos: (flags & 16) !== 0 ? encoding113_4.decode(state) : null
    }
  }
}

// @peartube/refresh-feed-request
const encoding114 = encoding0

// @peartube/refresh-feed-response
const encoding115 = encoding13
...
const encoding132 = {
  preencode(state, m) {
    ...
    if (m.stats) encoding132_0.preencode(state, m.stats)
  },
  encode(state, m) {
    ...
    if (m.stats) encoding132_0.encode(state, m.stats)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      stats: (flags & 1) !== 0 ? encoding132_0.decode(state) : null
    }
  }
}
...
const encoding136_0 = c.frame(encoding134)

// @peartube/get-seeding-status-response
const encoding136 = {
  preencode(state, m) {
    encoding136_0.preencode(state, m.status)
  },
  encode(state, m) {
    encoding136_0.encode(state, m.status)
  },
  decode(state) {
    const r0 = encoding136_0.decode(state)
...
const encoding137_0 = c.frame(encoding133)

// @peartube/set-seeding-config-request
const encoding137 = {
  preencode(state, m) {
    encoding137_0.preencode(state, m.config)
  },
  encode(state, m) {
    encoding137_0.encode(state, m.config)
  },
  decode(state) {
...
const encoding141_0 = c.frame(encoding139)

// @peartube/get-transcode-settings-response
const encoding141 = {
  preencode(state, m) {
    encoding141_0.preencode(state, m.settings)
  },
  encode(state, m) {
    encoding141_0.encode(state, m.settings)
  },
  decode(state) {
...
const encoding143_1 = encoding141_0

// @peartube/set-transcode-settings-response
const encoding143 = {
  preencode(state, m) {
    state.end++ // max flag is 2 so always one byte
    encoding143_1.preencode(state, m.settings)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding143_1.encode(state, m.settings)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      settings: encoding143_1.decode(state),
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding149_0 = c.array(c.string)
...
const encoding149 = {
  preencode(state, m) {
    ...
    if (m.channels) encoding149_0.preencode(state, m.channels)
  },
  encode(state, m) {
    ...
    if (m.channels) encoding149_0.encode(state, m.channels)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      channels: (flags & 1) !== 0 ? encoding149_0.decode(state) : null
    }
  }
}
...
const encoding160_0 = c.array(c.frame(encoding154))
...
const encoding160 = {
  preencode(state, m) {
    ...
    if (m.links) encoding160_0.preencode(state, m.links)
  },
  encode(state, m) {
    ...
    if (m.links) encoding160_0.encode(state, m.links)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      links: (flags & 1) !== 0 ? encoding160_0.decode(state) : null
    }
  }
}
...
const encoding169 = encoding131

// @peartube/get-video-metadata-response.video
const encoding170_0 = encoding47_0

// @peartube/get-video-metadata-response
const encoding170 = {
  preencode(state, m) {
    encoding170_0.preencode(state, m.video)
  },
  encode(state, m) {
    encoding170_0.encode(state, m.video)
  },
  decode(state) {
    const r0 = encoding170_0.decode(state)
...
const encoding175_8 = encoding149_0
// @peartube/desktop-browse-video.sections
const encoding175_10 = encoding149_0
...
const encoding175 = {
  preencode(state, m) {
    ...
    if (m.tags) encoding175_8.preencode(state, m.tags)
    if (m.accentHex) c.string.preencode(state, m.accentHex)
    if (m.sections) encoding175_10.preencode(state, m.sections)
    if (m.thumbnailUrl) c.string.preencode(state, m.thumbnailUrl)
    if (m.path) c.string.preencode(state, m.path)
    if (m.blobId) c.string.preencode(state, m.blobId)
    if (m.blobsCoreKey) c.string.preencode(state, m.blobsCoreKey)
  ...
  encode(state, m) {
    ...
    if (m.tags) encoding175_8.encode(state, m.tags)
    if (m.accentHex) c.string.encode(state, m.accentHex)
    if (m.sections) encoding175_10.encode(state, m.sections)
    if (m.thumbnailUrl) c.string.encode(state, m.thumbnailUrl)
    if (m.path) c.string.encode(state, m.path)
    if (m.blobId) c.string.encode(state, m.blobId)
    if (m.blobsCoreKey) c.string.encode(state, m.blobsCoreKey)
  ...
  decode(state) {
    ...
    return {
      ...
      tags: (flags & 8) !== 0 ? encoding175_8.decode(state) : null,
      accentHex: (flags & 16) !== 0 ? c.string.decode(state) : null,
      sections: (flags & 32) !== 0 ? encoding175_10.decode(state) : null,
...
const encoding176_0 = c.array(c.frame(encoding175))
// @peartube/desktop-browse-sections.subscriptions
const encoding176_1 = encoding176_0
// @peartube/desktop-browse-sections.library
const encoding176_2 = encoding176_0
// @peartube/desktop-browse-sections.studio
const encoding176_3 = encoding176_0
// @peartube/desktop-browse-sections.diagnostics
const encoding176_4 = encoding176_0
...
const encoding176 = {
  preencode(state, m) {
    ...
    if (m.home) encoding176_0.preencode(state, m.home)
    if (m.subscriptions) encoding176_1.preencode(state, m.subscriptions)
    if (m.library) encoding176_2.preencode(state, m.library)
    if (m.studio) encoding176_3.preencode(state, m.studio)
    if (m.diagnostics) encoding176_4.preencode(state, m.diagnostics)
  },
  encode(state, m) {
    const flags =
      (m.home ? 1 : 0) |
    ...
    if (m.home) encoding176_0.encode(state, m.home)
    if (m.subscriptions) encoding176_1.encode(state, m.subscriptions)
    if (m.library) encoding176_2.encode(state, m.library)
    if (m.studio) encoding176_3.encode(state, m.studio)
    if (m.diagnostics) encoding176_4.encode(state, m.diagnostics)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      home: (flags & 1) !== 0 ? encoding176_0.decode(state) : null,
      subscriptions: (flags & 2) !== 0 ? encoding176_1.decode(state) : null,
      library: (flags & 4) !== 0 ? encoding176_2.decode(state) : null,
      studio: (flags & 8) !== 0 ? encoding176_3.decode(state) : null,
      diagnostics: (flags & 16) !== 0 ? encoding176_4.decode(state) : null
    }
  }
}
...
const encoding178_0 = encoding149_0
// @peartube/desktop-browse-state.identityChannelKeys
const encoding178_1 = encoding149_0
...
const encoding178 = {
  preencode(state, m) {
    ...
    if (m.subscriptionChannelKeys) encoding178_0.preencode(state, m.subscriptionChannelKeys)
    if (m.identityChannelKeys) encoding178_1.preencode(state, m.identityChannelKeys)
  ...
  encode(state, m) {
    ...
    if (m.subscriptionChannelKeys) encoding178_0.encode(state, m.subscriptionChannelKeys)
    if (m.identityChannelKeys) encoding178_1.encode(state, m.identityChannelKeys)
  ...
  decode(state) {
    ...
    return {
      subscriptionChannelKeys: (flags & 1) !== 0 ? encoding178_0.decode(state) : null,
      identityChannelKeys: (flags & 2) !== 0 ? encoding178_1.decode(state) : null,
...
const encoding179_1 = c.frame(encoding176)
// @peartube/desktop-browse-snapshot.stats
const encoding179_2 = c.frame(encoding177)
// @peartube/desktop-browse-snapshot.state
const encoding179_3 = c.frame(encoding178)
...
const encoding179 = {
  preencode(state, m) {
    ...
    encoding179_1.preencode(state, m.sections)
    encoding179_2.preencode(state, m.stats)
    encoding179_3.preencode(state, m.state)
  },
  encode(state, m) {
    ...
    encoding179_1.encode(state, m.sections)
    encoding179_2.encode(state, m.stats)
    encoding179_3.encode(state, m.state)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      sections: encoding179_1.decode(state),
      stats: encoding179_2.decode(state),
      state: encoding179_3.decode(state)
    }
  }
}
...
const encoding181_5 = c.frame(encoding179)
...
const encoding181 = {
  preencode(state, m) {
    ...
    encoding181_5.preencode(state, m.snapshot)
  },
  encode(state, m) {
    const flags =
    ...
    encoding181_5.encode(state, m.snapshot)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      snapshot: encoding181_5.decode(state)
    }
  }
}
...
const encoding185_0 = encoding181_5

// @peartube/desktop-refresh-browse-response
const encoding185 = {
  preencode(state, m) {
    encoding185_0.preencode(state, m.snapshot)
  },
  encode(state, m) {
    encoding185_0.encode(state, m.snapshot)
  },
  decode(state) {
    const r0 = encoding185_0.decode(state)
...
const encoding199_0 = c.frame(encoding197)

// @peartube/get-status-response
const encoding199 = {
  preencode(state, m) {
    encoding199_0.preencode(state, m.status)
  },
  encode(state, m) {
    encoding199_0.encode(state, m.status)
  },
  decode(state) {
    const r0 = encoding199_0.decode(state)
...
const encoding208_0 = c.array(c.frame(encoding206))

// @peartube/global-search-videos-response
const encoding208 = {
  preencode(state, m) {
    encoding208_0.preencode(state, m.results)
  },
  encode(state, m) {
    encoding208_0.encode(state, m.results)
  },
  decode(state) {
    const r0 = encoding208_0.decode(state)
...
const encoding216 = encoding66

// @peartube/list-devices-response.devices
const encoding217_0 = c.array(c.frame(encoding209))

// @peartube/list-devices-response
const encoding217 = {
  preencode(state, m) {
    encoding217_0.preencode(state, m.devices)
  },
  encode(state, m) {
    encoding217_0.encode(state, m.devices)
  },
  decode(state) {
    const r0 = encoding217_0.decode(state)
...
const encoding224 = {
  preencode(state, m) {
    encoding224_0.preencode(state, m.stats)
  },
  encode(state, m) {
    encoding224_0.encode(state, m.stats)
  },
  decode(state) {
...
const encoding247_1 = c.array(c.frame(encoding246))

// @peartube/list-comments-response
const encoding247 = {
  preencode(state, m) {
    state.end++ // max flag is 2 so always one byte
    encoding247_1.preencode(state, m.comments)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding247_1.encode(state, m.comments)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      comments: encoding247_1.decode(state),
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding256 = encoding251

// @peartube/get-reactions-request
const encoding257 = encoding255

// @peartube/get-reactions-response.counts
const encoding258_1 = c.array(c.frame(encoding252))

// @peartube/get-reactions-response
const encoding258 = {
  preencode(state, m) {
    state.end++ // max flag is 4 so always one byte
    encoding258_1.preencode(state, m.counts)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding258_1.encode(state, m.counts)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      counts: encoding258_1.decode(state),
...
const encoding269_1 = c.frame(encoding259)
...
const encoding269 = {
  preencode(state, m) {
    ...
    if (m.device) encoding269_1.preencode(state, m.device)
    if (m.error) c.string.preencode(state, m.error)
  },
  encode(state, m) {
    ...
    if (m.device) encoding269_1.encode(state, m.device)
    if (m.error) c.string.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      device: (flags & 2) !== 0 ? encoding269_1.decode(state) : null,
      error: (flags & 4) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding271 = encoding53

// @peartube/cast-disconnect-request
const encoding272 = encoding0

// @peartube/cast-disconnect-response
const encoding273 = encoding53
...
const encoding285 = encoding53

// @peartube/cast-get-state-request
const encoding286 = encoding0
...
const encoding290_0 = encoding269_1

// @peartube/event-cast-device-found
const encoding290 = {
  preencode(state, m) {
    encoding290_0.preencode(state, m.device)
  },
  encode(state, m) {
    encoding290_0.encode(state, m.device)
  },
  decode(state) {
    const r0 = encoding290_0.decode(state)
...
const encoding295_0 = encoding208_0

// @peartube/search-videos-response
const encoding295 = {
  preencode(state, m) {
    encoding295_0.preencode(state, m.results)
  },
  encode(state, m) {
    encoding295_0.encode(state, m.results)
  },
  decode(state) {
...
const encoding297 = encoding53

// @peartube/index-video-vectors-request
const encoding298 = encoding131

// @peartube/index-video-vectors-response
const encoding299 = encoding53
...
const encoding302_1 = c.array(c.frame(encoding300))

// @peartube/get-recommendations-response
const encoding302 = {
  preencode(state, m) {
    state.end++ // max flag is 2 so always one byte
    encoding302_1.preencode(state, m.recommendations)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding302_1.encode(state, m.recommendations)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      recommendations: encoding302_1.decode(state),
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding304_1 = encoding302_1

// @peartube/get-video-recommendations-response
const encoding304 = {
  preencode(state, m) {
    state.end++ // max flag is 2 so always one byte
    encoding304_1.preencode(state, m.recommendations)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding304_1.encode(state, m.recommendations)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      recommendations: encoding304_1.decode(state),
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
