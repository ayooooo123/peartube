...
const encoding31 = {
  preencode(state, m) {
    ...
    if (m.stats) encoding31_5.preencode(state, m.stats)
  },
  encode(state, m) {
    const flags =
      (m.transcoded ? 1 : 0) |
    ...
    if (m.stats) encoding31_5.encode(state, m.stats)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      stats: (flags & 16) !== 0 ? encoding31_5.decode(state) : null,
...
const encoding33_0 = c.frame(encoding24)

// @peartube/get-video-data-response
const encoding33 = {
  preencode(state, m) {
    encoding33_0.preencode(state, m.video)
  },
  encode(state, m) {
    encoding33_0.encode(state, m.video)
  },
  decode(state) {
...
const encoding35 = {
  preencode(state, m) {
    encoding35_0.preencode(state, m.video)
  },
  encode(state, m) {
    encoding35_0.encode(state, m.video)
  },
  decode(state) {
...
const encoding48_0 = c.array(c.frame(encoding42))
...
const encoding48 = {
  preencode(state, m) {
    ...
    if (m.subscriptions) encoding48_0.preencode(state, m.subscriptions)
  },
  encode(state, m) {
    ...
    if (m.subscriptions) encoding48_0.encode(state, m.subscriptions)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      subscriptions: (flags & 1) !== 0 ? encoding48_0.decode(state) : null
    }
  }
}

// @peartube/join-channel-request
const encoding49 = encoding43
...
const encoding53_0 = c.array(c.frame(encoding51))
...
const encoding53 = {
  preencode(state, m) {
    ...
    if (m.entries) encoding53_0.preencode(state, m.entries)
  },
  encode(state, m) {
    ...
    if (m.entries) encoding53_0.encode(state, m.entries)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      entries: (flags & 1) !== 0 ? encoding53_0.decode(state) : null
    }
  }
}

// @peartube/refresh-feed-request
const encoding54 = encoding0

// @peartube/refresh-feed-response
const encoding55 = encoding10

// @peartube/submit-to-feed-request
const encoding56 = encoding0

// @peartube/submit-to-feed-response
const encoding57 = encoding10

// @peartube/unpublish-from-feed-request
const encoding58 = encoding0
...
const encoding72 = {
  preencode(state, m) {
    ...
    if (m.stats) encoding72_0.preencode(state, m.stats)
  },
  encode(state, m) {
    ...
    if (m.stats) encoding72_0.encode(state, m.stats)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      stats: (flags & 1) !== 0 ? encoding72_0.decode(state) : null
    }
  }
}
...
const encoding77_0 = c.frame(encoding73)

// @peartube/set-seeding-config-request
const encoding77 = {
  preencode(state, m) {
    encoding77_0.preencode(state, m.config)
  },
  encode(state, m) {
    encoding77_0.encode(state, m.config)
  },
  decode(state) {
...
const encoding80 = encoding0

// @peartube/get-transcode-settings-response.settings
const encoding81_0 = c.frame(encoding79)

// @peartube/get-transcode-settings-response
const encoding81 = {
  preencode(state, m) {
    encoding81_0.preencode(state, m.settings)
  },
  encode(state, m) {
    encoding81_0.encode(state, m.settings)
  },
  decode(state) {
...
const encoding83_1 = encoding81_0

// @peartube/set-transcode-settings-response
const encoding83 = {
  preencode(state, m) {
    state.end++ // max flag is 2 so always one byte
    encoding83_1.preencode(state, m.settings)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding83_1.encode(state, m.settings)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      settings: encoding83_1.decode(state),
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding84 = encoding43

// @peartube/pin-channel-response
const encoding85 = encoding10

// @peartube/unpin-channel-request
const encoding86 = encoding43
...
const encoding89_0 = c.array(c.string)
...
const encoding89 = {
  preencode(state, m) {
    ...
    if (m.channels) encoding89_0.preencode(state, m.channels)
  },
  encode(state, m) {
    ...
    if (m.channels) encoding89_0.encode(state, m.channels)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      channels: (flags & 1) !== 0 ? encoding89_0.decode(state) : null
    }
  }
}

// @peartube/get-storage-stats-request
const encoding90 = encoding0
...
const encoding98 = encoding71

// @peartube/get-video-metadata-response.video
const encoding99_0 = encoding33_0

// @peartube/get-video-metadata-response
const encoding99 = {
  preencode(state, m) {
    encoding99_0.preencode(state, m.video)
  },
  encode(state, m) {
    encoding99_0.encode(state, m.video)
  },
  decode(state) {
    const r0 = encoding99_0.decode(state)
...
const encoding106_0 = c.frame(encoding104)

// @peartube/get-status-response
const encoding106 = {
  preencode(state, m) {
    encoding106_0.preencode(state, m.status)
  },
  encode(state, m) {
    encoding106_0.encode(state, m.status)
  },
  decode(state) {
    const r0 = encoding106_0.decode(state)
...
const encoding115 = {
  preencode(state, m) {
    encoding115_0.preencode(state, m.results)
  },
  encode(state, m) {
    encoding115_0.encode(state, m.results)
  },
  decode(state) {
    const r0 = encoding115_0.decode(state)
...
const encoding123 = encoding43

// @peartube/list-devices-response.devices
const encoding124_0 = c.array(c.frame(encoding116))

// @peartube/list-devices-response
const encoding124 = {
  preencode(state, m) {
    encoding124_0.preencode(state, m.devices)
  },
  encode(state, m) {
    encoding124_0.encode(state, m.devices)
  },
  decode(state) {
    const r0 = encoding124_0.decode(state)
...
const encoding131 = {
  preencode(state, m) {
    encoding131_0.preencode(state, m.stats)
  },
  encode(state, m) {
    encoding131_0.encode(state, m.stats)
  },
  decode(state) {
    const r0 = encoding131_0.decode(state)
...
const encoding154_1 = c.array(c.frame(encoding153))

// @peartube/list-comments-response
const encoding154 = {
  preencode(state, m) {
    state.end++ // max flag is 2 so always one byte
    encoding154_1.preencode(state, m.comments)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding154_1.encode(state, m.comments)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      comments: encoding154_1.decode(state),
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding163 = encoding158

// @peartube/get-reactions-request
const encoding164 = encoding162

// @peartube/get-reactions-response.counts
const encoding165_1 = c.array(c.frame(encoding159))

// @peartube/get-reactions-response
const encoding165 = {
  preencode(state, m) {
    state.end++ // max flag is 4 so always one byte
    encoding165_1.preencode(state, m.counts)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding165_1.encode(state, m.counts)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      counts: encoding165_1.decode(state),
...
const encoding176_1 = c.frame(encoding166)
...
const encoding176 = {
  preencode(state, m) {
    ...
    if (m.device) encoding176_1.preencode(state, m.device)
    if (m.error) c.string.preencode(state, m.error)
  },
  encode(state, m) {
    ...
    if (m.device) encoding176_1.encode(state, m.device)
    if (m.error) c.string.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      device: (flags & 2) !== 0 ? encoding176_1.decode(state) : null,
      error: (flags & 4) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding197_0 = encoding176_1

// @peartube/event-cast-device-found
const encoding197 = {
  preencode(state, m) {
    encoding197_0.preencode(state, m.device)
  },
  encode(state, m) {
    encoding197_0.encode(state, m.device)
  },
  decode(state) {
...
const encoding202_0 = encoding115_0

// @peartube/search-videos-response
const encoding202 = {
  preencode(state, m) {
    encoding202_0.preencode(state, m.results)
  },
  encode(state, m) {
    encoding202_0.encode(state, m.results)
  },
  decode(state) {
    const r0 = encoding202_0.decode(state)
...
const encoding204 = encoding39

// @peartube/index-video-vectors-request
const encoding205 = encoding71

// @peartube/index-video-vectors-response
const encoding206 = encoding39
...
const encoding209_1 = c.array(c.frame(encoding207))

// @peartube/get-recommendations-response
const encoding209 = {
  preencode(state, m) {
    state.end++ // max flag is 2 so always one byte
    encoding209_1.preencode(state, m.recommendations)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding209_1.encode(state, m.recommendations)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      recommendations: encoding209_1.decode(state),
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding211_1 = encoding209_1
