...
const encoding130 = encoding44

// @peartube/transcode-status-request
const encoding131 = encoding129
...
const encoding145_0 = c.array(c.frame(encoding143))

// @peartube/global-search-videos-response
const encoding145 = {
  preencode(state, m) {
    encoding145_0.preencode(state, m.results)
  },
  encode(state, m) {
    encoding145_0.encode(state, m.results)
  },
  decode(state) {
...
const encoding153 = encoding48

// @peartube/list-devices-response.devices
const encoding154_0 = c.array(c.frame(encoding146))

// @peartube/list-devices-response
const encoding154 = {
  preencode(state, m) {
    encoding154_0.preencode(state, m.devices)
  },
  encode(state, m) {
    encoding154_0.encode(state, m.devices)
  },
  decode(state) {
...
const encoding161 = {
  preencode(state, m) {
    encoding161_0.preencode(state, m.stats)
  },
  encode(state, m) {
    encoding161_0.encode(state, m.stats)
  },
  decode(state) {
...
const encoding184_1 = c.array(c.frame(encoding183))

// @peartube/list-comments-response
const encoding184 = {
  preencode(state, m) {
    state.end++ // max flag is 2 so always one byte
    encoding184_1.preencode(state, m.comments)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding184_1.encode(state, m.comments)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      comments: encoding184_1.decode(state),
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding195 = {
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding195_1.encode(state, m.counts)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      counts: encoding195_1.decode(state),
...
const encoding204_0 = c.array(c.frame(encoding196))

// @peartube/cast-get-devices-response
const encoding204 = {
  preencode(state, m) {
    encoding204_0.preencode(state, m.devices)
  },
  encode(state, m) {
    encoding204_0.encode(state, m.devices)
  },
  decode(state) {
...
const encoding206_1 = c.frame(encoding196)
...
const encoding206 = {
  preencode(state, m) {
    ...
    if (m.device) encoding206_1.preencode(state, m.device)
    if (m.error) c.string.preencode(state, m.error)
  },
  encode(state, m) {
    ...
    if (m.device) encoding206_1.encode(state, m.device)
    if (m.error) c.string.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      device: (flags & 2) !== 0 ? encoding206_1.decode(state) : null,
      error: (flags & 4) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding227_0 = encoding206_1

// @peartube/event-cast-device-found
const encoding227 = {
  preencode(state, m) {
    encoding227_0.preencode(state, m.device)
  },
  encode(state, m) {
    encoding227_0.encode(state, m.device)
  },
  decode(state) {
...
const encoding232_0 = encoding145_0

// @peartube/search-videos-response
const encoding232 = {
  preencode(state, m) {
    encoding232_0.preencode(state, m.results)
  },
  encode(state, m) {
    encoding232_0.encode(state, m.results)
  },
  decode(state) {
    const r0 = encoding232_0.decode(state)
...
const encoding234 = encoding44

// @peartube/index-video-vectors-request
const encoding235 = encoding79

// @peartube/index-video-vectors-response
const encoding236 = encoding44
...
const encoding239_1 = c.array(c.frame(encoding237))

// @peartube/get-recommendations-response
const encoding239 = {
  preencode(state, m) {
    state.end++ // max flag is 2 so always one byte
    encoding239_1.preencode(state, m.recommendations)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding239_1.encode(state, m.recommendations)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      recommendations: encoding239_1.decode(state),
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding241_1 = encoding239_1

// @peartube/get-video-recommendations-response
const encoding241 = {
  preencode(state, m) {
    state.end++ // max flag is 2 so always one byte
    encoding241_1.preencode(state, m.recommendations)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding241_1.encode(state, m.recommendations)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      recommendations: encoding241_1.decode(state),
      error: (flags & 2) !== 0 ? c.string.decode(state) : null
    }
  }
}
...
const encoding246_1 = c.frame(encoding245)
...
const encoding246 = {
  preencode(state, m) {
    ...
    if (version >= 2 && m.status) encoding246_1.preencode(state, m.status)
    if (version >= 2 && m.error) c.string.preencode(state, m.error)
  },
  encode(state, m) {
    const flags =
    ...
    if (version >= 2 && m.status) encoding246_1.encode(state, m.status)
    if (version >= 2 && m.error) c.string.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (version >= 2 && (flags & 1) !== 0),
      status: (version >= 2 && (flags & 2) !== 0) ? encoding246_1.decode(state) : null,
...
const encoding247 = encoding43

// @peartube/get-livestream-status-response.status
const encoding248_0 = encoding246_1
...
const encoding248 = {
  preencode(state, m) {
    ...
    if (version >= 2 && m.status) encoding248_0.preencode(state, m.status)
    if (version >= 2 && m.error) c.string.preencode(state, m.error)
  },
  encode(state, m) {
    ...
    if (version >= 2 && m.status) encoding248_0.encode(state, m.status)
    if (version >= 2 && m.error) c.string.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      status: (version >= 2 && (flags & 1) !== 0) ? encoding248_0.decode(state) : null,
...
const encoding258_0 = c.array(c.frame(encoding252))
...
const encoding258 = {
  preencode(state, m) {
    ...
    if (version >= 4 && m.playlists) encoding258_0.preencode(state, m.playlists)
  },
  encode(state, m) {
    ...
    if (version >= 4 && m.playlists) encoding258_0.encode(state, m.playlists)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      playlists: (version >= 4 && (flags & 1) !== 0) ? encoding258_0.decode(state) : null
    }
  }
}
...
const encoding260_0 = c.array(c.frame(encoding253))
...
const encoding260 = {
  preencode(state, m) {
    ...
    if (version >= 4 && m.items) encoding260_0.preencode(state, m.items)
  },
  encode(state, m) {
    ...
    if (version >= 4 && m.items) encoding260_0.encode(state, m.items)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      items: (version >= 4 && (flags & 1) !== 0) ? encoding260_0.decode(state) : null
    }
  }
}
...
const encoding274_0 = c.array(c.frame(encoding254))
...
const encoding274 = {
  preencode(state, m) {
    ...
    if (version >= 4 && m.entries) encoding274_0.preencode(state, m.entries)
  },
  encode(state, m) {
    ...
    if (version >= 4 && m.entries) encoding274_0.encode(state, m.entries)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      entries: (version >= 4 && (flags & 1) !== 0) ? encoding274_0.decode(state) : null
    }
  }
}
...
const encoding276_1 = c.frame(encoding255)
...
const encoding276 = {
  preencode(state, m) {
    ...
    if (version >= 4 && m.resume) encoding276_1.preencode(state, m.resume)
  },
  encode(state, m) {
    ...
    if (version >= 4 && m.resume) encoding276_1.encode(state, m.resume)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      resume: (version >= 4 && (flags & 2) !== 0) ? encoding276_1.decode(state) : null
    }
  }
}

// @peartube/list-resume-positions-request
const encoding277 = encoding0

// @peartube/list-resume-positions-response.entries
const encoding278_0 = c.array(c.frame(encoding255))
...
const encoding278 = {
  preencode(state, m) {
    ...
    if (version >= 4 && m.entries) encoding278_0.preencode(state, m.entries)
  },
  encode(state, m) {
    const flags = (version >= 4 && m.entries) ? 1 : 0
    ...
    if (version >= 4 && m.entries) encoding278_0.encode(state, m.entries)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      entries: (version >= 4 && (flags & 1) !== 0) ? encoding278_0.decode(state) : null
    }
  }
}

// @peartube/set-personal-setting-request
const encoding279 = encoding256

// @peartube/set-personal-setting-response
const encoding280 = encoding264

// @peartube/get-personal-settings-request
const encoding281 = encoding0

// @peartube/get-personal-settings-response.settings
const encoding282_0 = c.array(c.frame(encoding256))
...
const encoding282 = {
  preencode(state, m) {
    ...
    if (version >= 4 && m.settings) encoding282_0.preencode(state, m.settings)
  },
  encode(state, m) {
    ...
    if (version >= 4 && m.settings) encoding282_0.encode(state, m.settings)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      settings: (version >= 4 && (flags & 1) !== 0) ? encoding282_0.decode(state) : null
    }
  }
}
...
const encoding57_14 = c.array(c.frame(encoding251))
...
const encoding161_0 = encoding35_1
