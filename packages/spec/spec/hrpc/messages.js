...
const encoding221 = {
  preencode(state, m) {
    ...
    if (version >= 5 && m.videoToolboxDecodeSource) c.string.preencode(state, m.videoToolboxDecodeSource)
  },
  encode(state, m) {
    const flags =
      ((version >= 5 && m.videoToolboxDecodeEnabled) ? 1 : 0) |
      ((version >= 5 && m.videoToolboxDecodeLocked) ? 2 : 0) |
      ((version >= 5 && m.videoToolboxDecodeDefault) ? 4 : 0) |
      ((version >= 5 && m.videoToolboxDecodeSource) ? 8 : 0)

    c.uint.encode(state, flags)

    if (version >= 5 && m.videoToolboxDecodeSource) c.string.encode(state, m.videoToolboxDecodeSource)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      videoToolboxDecodeEnabled: (version >= 5 && (flags & 1) !== 0),
      videoToolboxDecodeLocked: (version >= 5 && (flags & 2) !== 0),
      videoToolboxDecodeDefault: (version >= 5 && (flags & 4) !== 0),
      videoToolboxDecodeSource: (version >= 5 && (flags & 8) !== 0) ? c.string.decode(state) : null
    }
  }
}
...
const encoding223_0 = c.frame(encoding221)

// @peartube/get-transcode-settings-response
const encoding223 = {
  preencode(state, m) {
    encoding223_0.preencode(state, m.settings)
  },
  encode(state, m) {
    encoding223_0.encode(state, m.settings)
  },
  decode(state) {
...
const encoding224 = {
  ...
  encode(state, m) {
    const flags = (version >= 5 && m.videoToolboxDecodeEnabled) ? 1 : 0
...
const encoding225_1 = encoding223_0

// @peartube/set-transcode-settings-response
const encoding225 = {
  preencode(state, m) {
    state.end++ // max flag is 2 so always one byte
    encoding225_1.preencode(state, m.settings)
  ...
  encode(state, m) {
    ...
    c.uint.encode(state, flags)
    encoding225_1.encode(state, m.settings)
  ...
  decode(state) {
    ...
    return {
      ...
      settings: encoding225_1.decode(state),
