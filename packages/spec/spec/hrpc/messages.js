...
const encoding387_3 = c.frame(encoding385)
...
const encoding387 = {
  preencode(state, m) {
    ...
    if (m.cursor) c.string.preencode(state, m.cursor)
    if (m.limit) c.uint.preencode(state, m.limit)
    if (m.selector) encoding387_3.preencode(state, m.selector)
  },
  encode(state, m) {
    ...
    if (m.cursor) c.string.encode(state, m.cursor)
    if (m.limit) c.uint.encode(state, m.limit)
    if (m.selector) encoding387_3.encode(state, m.selector)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      cursor: (flags & 1) !== 0 ? c.string.decode(state) : null,
      limit: (flags & 2) !== 0 ? c.uint.decode(state) : 0,
      selector: (flags & 4) !== 0 ? encoding387_3.decode(state) : null
    }
  }
}

// @peartube/provider-search-response.hits
const encoding388_1 = c.array(c.frame(encoding384))
// @peartube/provider-search-response.error
const encoding388_3 = c.frame(encoding383)
// @peartube/provider-search-response.diagnostics
const encoding388_4 = c.frame(encoding386)

// @peartube/provider-search-response
const encoding388 = {
  preencode(state, m) {
    state.end++ // max flag is 32 so always one byte
    encoding388_1.preencode(state, m.hits)

    if (m.nextCursor) c.string.preencode(state, m.nextCursor)
    if (m.error) encoding388_3.preencode(state, m.error)
    if (m.diagnostics) encoding388_4.preencode(state, m.diagnostics)
  },
  encode(state, m) {
    const flags =
      (m.success ? 1 : 0) |
    ...
    c.uint.encode(state, flags)
    encoding388_1.encode(state, m.hits)

    if (m.nextCursor) c.string.encode(state, m.nextCursor)
    if (m.error) encoding388_3.encode(state, m.error)
    if (m.diagnostics) encoding388_4.encode(state, m.diagnostics)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      hits: encoding388_1.decode(state),
      nextCursor: (flags & 2) !== 0 ? c.string.decode(state) : null,
      error: (flags & 4) !== 0 ? encoding388_3.decode(state) : null,
      diagnostics: (flags & 8) !== 0 ? encoding388_4.decode(state) : null,
      partial: (flags & 16) !== 0,
      stale: (flags & 32) !== 0
    }
  }
...
const encoding391_1 = c.frame(encoding389)
// @peartube/resolve-provider-ref-response.error
const encoding391_2 = encoding388_3
...
const encoding391 = {
  preencode(state, m) {
    ...
    if (m.resolution) encoding391_1.preencode(state, m.resolution)
  ...
  encode(state, m) {
    ...
    if (m.resolution) encoding391_1.encode(state, m.resolution)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      resolution: (flags & 2) !== 0 ? encoding391_1.decode(state) : null,
...
const encoding392 = {
  preencode(state, m) {
    ...
    if (m.retentionUntil) c.uint.preencode(state, m.retentionUntil)
    if (version >= 2 && m.sourceFileName) c.string.preencode(state, m.sourceFileName)
  },
  encode(state, m) {
    const flags =
      (m.retentionUntil ? 1 : 0) |
      (m.retentionUntilPresent ? 2 : 0) |
      ((version >= 2 && m.sourceFileName) ? 4 : 0)
    ...
    if (m.retentionUntil) c.uint.encode(state, m.retentionUntil)
    if (version >= 2 && m.sourceFileName) c.string.encode(state, m.sourceFileName)
  },
  decode(state) {
    const r0 = c.uint.decode(state)
    const r1 = c.string.decode(state)
    ...
    return {
      ...
      sourceFileName: (version >= 2 && (flags & 4) !== 0) ? c.string.decode(state) : null
    }
  }
}
...
const encoding393 = {
  preencode(state, m) {
    const flags =
      ...
      (m.errorCode ? 32 : 0) |
      (m.recoverable ? 64 : 0) |
      ((version >= 2 && m.title) ? 128 : 0) |
      ((version >= 2 && m.sourceFileName) ? 256 : 0) |
      ((version >= 2 && m.mediaContext) ? 512 : 0)
    ...
    if (version >= 2 && m.sourceFileName) c.string.preencode(state, m.sourceFileName)
    if (version >= 2 && m.mediaContext) encoding393_16.preencode(state, m.mediaContext)
  },
  encode(state, m) {
    const flags =
      (m.expectedBytes ? 1 : 0) |
    ...
    if (version >= 2 && m.sourceFileName) c.string.encode(state, m.sourceFileName)
    if (version >= 2 && m.mediaContext) encoding393_16.encode(state, m.mediaContext)
  },
  decode(state) {
    const r0 = c.uint.decode(state)
    const r1 = c.string.decode(state)
    ...
    return {
      ...
      updatedAt: c.uint.decode(state),
      title: (version >= 2 && (flags & 128) !== 0) ? c.string.decode(state) : null,
      sourceFileName: (version >= 2 && (flags & 256) !== 0) ? c.string.decode(state) : null,
      mediaContext: (version >= 2 && (flags & 512) !== 0) ? encoding393_16.decode(state) : null
    }
  }
}

// @peartube/request-acquisition-request.request
const encoding394_1 = c.frame(encoding392)

// @peartube/request-acquisition-request
const encoding394 = {
  preencode(state, m) {
    c.string.preencode(state, m.idempotencyKey)
    encoding394_1.preencode(state, m.request)
  },
  encode(state, m) {
    c.string.encode(state, m.idempotencyKey)
    encoding394_1.encode(state, m.request)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const r1 = encoding394_1.decode(state)
...
const encoding395_1 = c.frame(encoding393)
// @peartube/request-acquisition-response.error
const encoding395_2 = encoding388_3
...
const encoding397_1 = encoding395_1
// @peartube/attach-source-grant-response.error
const encoding397_2 = encoding388_3
...
const encoding399_1 = encoding395_1
// @peartube/get-acquisition-response.error
const encoding399_2 = encoding388_3
...
const encoding400_2 = encoding44_11
...
const encoding400 = {
  preencode(state, m) {
    ...
    if (m.cursor) c.string.preencode(state, m.cursor)
    if (m.limit) c.uint.preencode(state, m.limit)
    if (m.states) encoding400_2.preencode(state, m.states)
  },
  encode(state, m) {
    ...
    if (m.cursor) c.string.encode(state, m.cursor)
    if (m.limit) c.uint.encode(state, m.limit)
    if (m.states) encoding400_2.encode(state, m.states)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      cursor: (flags & 1) !== 0 ? c.string.decode(state) : null,
      limit: (flags & 2) !== 0 ? c.uint.decode(state) : 0,
      states: (flags & 4) !== 0 ? encoding400_2.decode(state) : null
    }
  }
}

// @peartube/list-acquisitions-response.acquisitions
const encoding401_1 = c.array(c.frame(encoding393))
// @peartube/list-acquisitions-response.error
const encoding401_3 = encoding388_3

// @peartube/list-acquisitions-response
const encoding401 = {
  preencode(state, m) {
    state.end++ // max flag is 4 so always one byte
    encoding401_1.preencode(state, m.acquisitions)

    if (m.nextCursor) c.string.preencode(state, m.nextCursor)
    if (m.error) encoding401_3.preencode(state, m.error)
  },
  encode(state, m) {
    const flags = (m.success ? 1 : 0) | (m.nextCursor ? 2 : 0) | (m.error ? 4 : 0)

    c.uint.encode(state, flags)
    encoding401_1.encode(state, m.acquisitions)

    if (m.nextCursor) c.string.encode(state, m.nextCursor)
    if (m.error) encoding401_3.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      acquisitions: encoding401_1.decode(state),
      nextCursor: (flags & 2) !== 0 ? c.string.decode(state) : null,
      error: (flags & 4) !== 0 ? encoding401_3.decode(state) : null
    }
  }
}

// @peartube/cancel-acquisition-request
const encoding402 = encoding398

// @peartube/cancel-acquisition-response.acquisition
const encoding403_1 = encoding395_1
// @peartube/cancel-acquisition-response.error
const encoding403_2 = encoding388_3
...
const encoding404 = encoding398

// @peartube/retry-acquisition-response.acquisition
const encoding405_1 = encoding395_1
// @peartube/retry-acquisition-response.error
const encoding405_2 = encoding388_3
...
const encoding405 = {
  preencode(state, m) {
    ...
    if (m.acquisition) encoding405_1.preencode(state, m.acquisition)
  ...
  encode(state, m) {
    ...
    if (m.acquisition) encoding405_1.encode(state, m.acquisition)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      acquisition: (flags & 2) !== 0 ? encoding405_1.decode(state) : null,
...
const encoding408_2 = encoding388_3
...
const encoding408 = {
  preencode(state, m) {
    ...
    if (m.publication) encoding408_1.preencode(state, m.publication)
  ...
  encode(state, m) {
    ...
    if (m.publication) encoding408_1.encode(state, m.publication)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      publication: (flags & 2) !== 0 ? encoding408_1.decode(state) : null,
...
const encoding411_2 = encoding388_3
...
const encoding411 = {
  preencode(state, m) {
    ...
    if (m.stream) encoding411_1.preencode(state, m.stream)
  ...
  encode(state, m) {
    ...
    if (m.stream) encoding411_1.encode(state, m.stream)
  ...
  decode(state) {
    ...
    return {
      success: (flags & 1) !== 0,
      stream: (flags & 2) !== 0 ? encoding411_1.decode(state) : null,
...
const encoding413 = encoding0

// @peartube/get-provider-status-response.status
const encoding414_1 = c.frame(encoding412)
// @peartube/get-provider-status-response.error
const encoding414_2 = encoding388_3
...
const encoding414 = {
  preencode(state, m) {
    ...
    if (m.status) encoding414_1.preencode(state, m.status)
    if (m.error) encoding414_2.preencode(state, m.error)
  },
  encode(state, m) {
    const flags = (m.success ? 1 : 0) | (m.status ? 2 : 0) | (m.error ? 4 : 0)
    ...
    if (m.status) encoding414_1.encode(state, m.status)
    if (m.error) encoding414_2.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      status: (flags & 2) !== 0 ? encoding414_1.decode(state) : null,
      error: (flags & 4) !== 0 ? encoding414_2.decode(state) : null
    }
  }
}
...
const encoding416 = encoding0

// @peartube/get-provider-policy-response.policy
const encoding417_1 = c.frame(encoding415)
// @peartube/get-provider-policy-response.error
const encoding417_2 = encoding388_3
...
const encoding418_0 = encoding417_1
...
const encoding419_1 = encoding417_1
// @peartube/set-provider-policy-response.error
const encoding419_2 = encoding388_3
...
const encoding420_7 = encoding44_11
// @peartube/acquisition-policy-v1.allowedAdapterIds
const encoding420_8 = encoding44_11
...
const encoding420 = {
  preencode(state, m) {
    ...
    encoding420_7.preencode(state, m.allowedPublisherIds)
    encoding420_8.preencode(state, m.allowedAdapterIds)
  ...
  encode(state, m) {
    ...
    encoding420_7.encode(state, m.allowedPublisherIds)
    encoding420_8.encode(state, m.allowedAdapterIds)
  ...
  decode(state) {
    ...
    return {
      ...
      allowedPublisherIds: encoding420_7.decode(state),
      allowedAdapterIds: encoding420_8.decode(state),
...
const encoding421 = encoding0

// @peartube/get-acquisition-policy-response.policy
const encoding422_1 = c.frame(encoding420)
// @peartube/get-acquisition-policy-response.error
const encoding422_2 = encoding388_3
...
const encoding422 = {
  preencode(state, m) {
    ...
    if (m.policy) encoding422_1.preencode(state, m.policy)
    if (m.error) encoding422_2.preencode(state, m.error)
  },
  encode(state, m) {
    const flags = (m.success ? 1 : 0) | (m.policy ? 2 : 0) | (m.error ? 4 : 0)
    ...
    if (m.policy) encoding422_1.encode(state, m.policy)
    if (m.error) encoding422_2.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      policy: (flags & 2) !== 0 ? encoding422_1.decode(state) : null,
      error: (flags & 4) !== 0 ? encoding422_2.decode(state) : null
    }
  }
}
...
const encoding424_0 = encoding422_1
// @peartube/set-acquisition-policy-request.consent
const encoding424_2 = c.frame(encoding423)

// @peartube/set-acquisition-policy-request
const encoding424 = {
  preencode(state, m) {
    encoding424_0.preencode(state, m.policy)
    c.uint.preencode(state, m.expectedRevision)
    encoding424_2.preencode(state, m.consent)
  },
  encode(state, m) {
    encoding424_0.encode(state, m.policy)
    c.uint.encode(state, m.expectedRevision)
    encoding424_2.encode(state, m.consent)
  },
  decode(state) {
    const r0 = encoding424_0.decode(state)
    const r1 = c.uint.decode(state)
    const r2 = encoding424_2.decode(state)
...
const encoding425_1 = encoding422_1
// @peartube/set-acquisition-policy-response.error
const encoding425_2 = encoding388_3
...
const encoding425 = {
  preencode(state, m) {
    ...
    if (m.policy) encoding425_1.preencode(state, m.policy)
    if (m.error) encoding425_2.preencode(state, m.error)
  },
  encode(state, m) {
    const flags = (m.success ? 1 : 0) | (m.policy ? 2 : 0) | (m.error ? 4 : 0)
    ...
    if (m.policy) encoding425_1.encode(state, m.policy)
    if (m.error) encoding425_2.encode(state, m.error)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      success: (flags & 1) !== 0,
      policy: (flags & 2) !== 0 ? encoding425_1.decode(state) : null,
      error: (flags & 4) !== 0 ? encoding425_2.decode(state) : null
    }
  }
}
...
const encoding427 = {
  preencode(state, m) {
    const flags =
      ((version >= 2 && m.kind) ? 1 : 0) |
      ((version >= 2 && m.namespace) ? 2 : 0) |
      ((version >= 2 && m.identifier) ? 4 : 0) |
      ((version >= 2 && m.title) ? 8 : 0) |
      ((version >= 2 && m.season) ? 16 : 0) |
      ((version >= 2 && m.episode) ? 32 : 0) |
      ((version >= 2 && m.releaseYear) ? 64 : 0) |
      ((version >= 2 && m.workEntityId) ? 128 : 0)

    c.uint.preencode(state, flags)

    if (version >= 2 && m.kind) c.string.preencode(state, m.kind)
    if (version >= 2 && m.namespace) c.string.preencode(state, m.namespace)
    if (version >= 2 && m.identifier) c.string.preencode(state, m.identifier)
    if (version >= 2 && m.title) c.string.preencode(state, m.title)
    if (version >= 2 && m.season) c.uint.preencode(state, m.season)
    if (version >= 2 && m.episode) c.uint.preencode(state, m.episode)
    if (version >= 2 && m.releaseYear) c.uint.preencode(state, m.releaseYear)
    if (version >= 2 && m.workEntityId) c.string.preencode(state, m.workEntityId)
  },
  encode(state, m) {
    const flags =
      ((version >= 2 && m.kind) ? 1 : 0) |
    ...
    if (version >= 2 && m.kind) c.string.encode(state, m.kind)
    if (version >= 2 && m.namespace) c.string.encode(state, m.namespace)
    if (version >= 2 && m.identifier) c.string.encode(state, m.identifier)
    if (version >= 2 && m.title) c.string.encode(state, m.title)
    if (version >= 2 && m.season) c.uint.encode(state, m.season)
    if (version >= 2 && m.episode) c.uint.encode(state, m.episode)
    if (version >= 2 && m.releaseYear) c.uint.encode(state, m.releaseYear)
    if (version >= 2 && m.workEntityId) c.string.encode(state, m.workEntityId)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      kind: (version >= 2 && (flags & 1) !== 0) ? c.string.decode(state) : null,
      namespace: (version >= 2 && (flags & 2) !== 0) ? c.string.decode(state) : null,
      identifier: (version >= 2 && (flags & 4) !== 0) ? c.string.decode(state) : null,
      title: (version >= 2 && (flags & 8) !== 0) ? c.string.decode(state) : null,
      season: (version >= 2 && (flags & 16) !== 0) ? c.uint.decode(state) : 0,
      episode: (version >= 2 && (flags & 32) !== 0) ? c.uint.decode(state) : 0,
      releaseYear: (version >= 2 && (flags & 64) !== 0) ? c.uint.decode(state) : 0,
      workEntityId: (version >= 2 && (flags & 128) !== 0) ? c.string.decode(state) : null
    }
  }
}
...
// @peartube/acquisition-v1.mediaContext, deferred due to recusive use
const encoding393_16 = c.frame(encoding427)
