...
export function createScopedNetworkApi (runtime) {
  ...
  return {
    ...
    getActiveAssetSession: request => runtime.getActiveAssetSession(request),
    ...
    retainAcquisitionCore: request => runtime.retainAcquisitionCore(request),
    releaseAcquisitionCore: request => runtime.releaseAcquisitionCore(request),
