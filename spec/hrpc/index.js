...
const methods = new Map([
  ...
  ['@peartube/refresh-feed', 23],
  [23, '@peartube/refresh-feed'],
  ['@peartube/submit-to-feed', 24],
  [24, '@peartube/submit-to-feed'],
  ['@peartube/unpublish-from-feed', 25],
  [25, '@peartube/unpublish-from-feed'],
  ['@peartube/is-channel-published', 26],
  [26, '@peartube/is-channel-published'],
  ['@peartube/hide-channel', 27],
  [27, '@peartube/hide-channel'],
  ['@peartube/get-channel-meta', 28],
  [28, '@peartube/get-channel-meta'],
  ['@peartube/get-swarm-status', 29],
  [29, '@peartube/get-swarm-status'],
  ['@peartube/create-device-invite', 30],
  [30, '@peartube/create-device-invite'],
  ['@peartube/pair-device', 31],
  [31, '@peartube/pair-device'],
  ['@peartube/list-devices', 32],
  [32, '@peartube/list-devices'],
  ['@peartube/retry-sync-channel', 33],
  [33, '@peartube/retry-sync-channel'],
  ['@peartube/prefetch-video', 34],
  [34, '@peartube/prefetch-video'],
  ['@peartube/get-video-stats', 35],
  [35, '@peartube/get-video-stats'],
  ['@peartube/get-seeding-status', 36],
  [36, '@peartube/get-seeding-status'],
  ['@peartube/set-seeding-config', 37],
  [37, '@peartube/set-seeding-config'],
  ['@peartube/get-transcode-settings', 38],
  [38, '@peartube/get-transcode-settings'],
  ['@peartube/set-transcode-settings', 39],
  [39, '@peartube/set-transcode-settings'],
  ['@peartube/pin-channel', 40],
  [40, '@peartube/pin-channel'],
  ['@peartube/unpin-channel', 41],
  [41, '@peartube/unpin-channel'],
  ['@peartube/get-pinned-channels', 42],
  [42, '@peartube/get-pinned-channels'],
  ['@peartube/get-storage-stats', 43],
  [43, '@peartube/get-storage-stats'],
  ['@peartube/set-storage-limit', 44],
  [44, '@peartube/set-storage-limit'],
  ['@peartube/clear-cache', 45],
  [45, '@peartube/clear-cache'],
  ['@peartube/get-video-thumbnail', 46],
  [46, '@peartube/get-video-thumbnail'],
  ['@peartube/get-video-metadata', 47],
  [47, '@peartube/get-video-metadata'],
  ['@peartube/set-video-thumbnail', 48],
  [48, '@peartube/set-video-thumbnail'],
  ['@peartube/set-video-thumbnail-from-file', 49],
  [49, '@peartube/set-video-thumbnail-from-file'],
  ['@peartube/get-status', 50],
  [50, '@peartube/get-status'],
  ['@peartube/pick-video-file', 51],
  [51, '@peartube/pick-video-file'],
  ['@peartube/pick-image-file', 52],
  [52, '@peartube/pick-image-file'],
  ['@peartube/get-blob-server-port', 53],
  [53, '@peartube/get-blob-server-port'],
  ['@peartube/global-search-videos', 54],
  [54, '@peartube/global-search-videos'],
  ...
  ['@peartube/event-ready', 62],
  [62, '@peartube/event-ready'],
  ['@peartube/event-error', 63],
  [63, '@peartube/event-error'],
  ['@peartube/event-upload-progress', 64],
  [64, '@peartube/event-upload-progress'],
  ['@peartube/event-download-progress', 65],
  [65, '@peartube/event-download-progress'],
  ['@peartube/event-feed-update', 66],
  [66, '@peartube/event-feed-update'],
  ['@peartube/event-log', 67],
  [67, '@peartube/event-log'],
  ['@peartube/event-video-stats', 68],
  [68, '@peartube/event-video-stats'],
  ['@peartube/cast-available', 69],
  [69, '@peartube/cast-available'],
  ['@peartube/cast-start-discovery', 70],
  [70, '@peartube/cast-start-discovery'],
  ['@peartube/cast-stop-discovery', 71],
  [71, '@peartube/cast-stop-discovery'],
  ['@peartube/cast-get-devices', 72],
  [72, '@peartube/cast-get-devices'],
  ['@peartube/cast-add-manual-device', 73],
  [73, '@peartube/cast-add-manual-device'],
  ['@peartube/cast-connect', 74],
  [74, '@peartube/cast-connect'],
  ['@peartube/cast-disconnect', 75],
  [75, '@peartube/cast-disconnect'],
  ['@peartube/cast-play', 76],
  [76, '@peartube/cast-play'],
  ['@peartube/cast-pause', 77],
  [77, '@peartube/cast-pause'],
  ['@peartube/cast-resume', 78],
  [78, '@peartube/cast-resume'],
  ['@peartube/cast-stop', 79],
  [79, '@peartube/cast-stop'],
  ['@peartube/cast-seek', 80],
  [80, '@peartube/cast-seek'],
  ['@peartube/cast-set-volume', 81],
  [81, '@peartube/cast-set-volume'],
  ['@peartube/cast-get-state', 82],
  [82, '@peartube/cast-get-state'],
  ['@peartube/cast-is-connected', 83],
  [83, '@peartube/cast-is-connected'],
  ['@peartube/event-cast-device-found', 84],
  [84, '@peartube/event-cast-device-found'],
  ['@peartube/event-cast-device-lost', 85],
  [85, '@peartube/event-cast-device-lost'],
  ['@peartube/event-cast-playback-state', 86],
  [86, '@peartube/event-cast-playback-state'],
  ['@peartube/event-cast-time-update', 87],
  [87, '@peartube/event-cast-time-update'],
  ['@peartube/search-videos', 88],
  [88, '@peartube/search-videos'],
  ['@peartube/log-watch-event', 89],
  [89, '@peartube/log-watch-event'],
  ['@peartube/index-video-vectors', 90],
  [90, '@peartube/index-video-vectors'],
  ['@peartube/get-recommendations', 91],
  [91, '@peartube/get-recommendations'],
  ['@peartube/get-video-recommendations', 92],
  [92, '@peartube/get-video-recommendations'],
  ['@peartube/update-video-metadata', 93],
  [93, '@peartube/update-video-metadata']
])
