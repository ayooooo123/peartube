...
const TEST_FILES = [
  ...
  'relay-personal-custody.test.mjs',
  'relay-publisher-shell.test.mjs',
  'relay-offload-lifecycle.test.mjs',
  'block-offload-residency.test.mjs',
  'offload-capacity.test.mjs',
  'offload-download-headroom.test.mjs',
  'archive-range-timing.test.mjs',
  'streaming-archive.test.mjs',
  'release-console.test.mjs',
  's3-signer.test.mjs',
