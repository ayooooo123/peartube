...
const encoding24 = {
  preencode(state, m) {
    const flags =
      ...
      ((version >= 3 && m.thumbnailBlobId) ? 4096 : 0) |
      ((version >= 3 && m.thumbnailBlobsCoreKey) ? 8192 : 0) |
      ((version >= 3 && m.thumbnailMimeType) ? 16384 : 0) |
      ((version >= 3 && m.publicBeeKey) ? 32768 : 0)
    ...
    if (version >= 3 && m.publicBeeKey) c.string.preencode(state, m.publicBeeKey)
  },
  encode(state, m) {
    const flags =
      (m.description ? 1 : 0) |
    ...
    if (version >= 3 && m.publicBeeKey) c.string.encode(state, m.publicBeeKey)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const r1 = c.string.decode(state)
    ...
    return {
      ...
      thumbnailBlobId: (version >= 3 && (flags & 4096) !== 0) ? c.string.decode(state) : null,
      thumbnailBlobsCoreKey: (version >= 3 && (flags & 8192) !== 0) ? c.string.decode(state) : null,
      thumbnailMimeType: (version >= 3 && (flags & 16384) !== 0) ? c.string.decode(state) : null,
      publicBeeKey: (version >= 3 && (flags & 32768) !== 0) ? c.string.decode(state) : null
    }
  }
}
