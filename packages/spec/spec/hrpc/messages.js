...
const encoding57 = {
  preencode(state, m) {
    const flags =
      ...
      ((version >= 3 && m.isLive) ? 4096 : 0) |
      ((version >= 3 && m.liveStreams) ? 8192 : 0)
    ...
    if (version >= 3 && m.liveStreams) encoding57_14.preencode(state, m.liveStreams)
  },
  encode(state, m) {
    const flags =
      (m.publicBeeKey ? 1 : 0) |
    ...
    if (version >= 3 && m.liveStreams) encoding57_14.encode(state, m.liveStreams)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      isLive: (version >= 3 && (flags & 4096) !== 0),
      liveStreams: (version >= 3 && (flags & 8192) !== 0) ? encoding57_14.decode(state) : null
    }
  }
}
...
const encoding261 = {
  preencode(state, m) {
    ...
    if (version >= 3 && m.startedAt) c.uint.preencode(state, m.startedAt)
  },
  encode(state, m) {
    const flags = ((version >= 3 && m.title) ? 1 : 0) | ((version >= 3 && m.startedAt) ? 2 : 0)
    ...
    if (version >= 3 && m.startedAt) c.uint.encode(state, m.startedAt)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const r1 = c.string.decode(state)
    ...
    return {
      ...
      startedAt: (version >= 3 && (flags & 2) !== 0) ? c.uint.decode(state) : 0
    }
  }
}
...
const encoding262 = {
  preencode(state, m) {
    ...
    if (version >= 4 && m.createdAt) c.uint.preencode(state, m.createdAt)
    if (version >= 4 && m.updatedAt) c.uint.preencode(state, m.updatedAt)
  },
  encode(state, m) {
    const flags =
      ((version >= 4 && m.name) ? 1 : 0) |
      ((version >= 4 && m.description) ? 2 : 0) |
      ((version >= 4 && m.createdAt) ? 4 : 0) |
      ((version >= 4 && m.updatedAt) ? 8 : 0)
    ...
    if (version >= 4 && m.createdAt) c.uint.encode(state, m.createdAt)
    if (version >= 4 && m.updatedAt) c.uint.encode(state, m.updatedAt)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      description: (version >= 4 && (flags & 2) !== 0) ? c.string.decode(state) : null,
      createdAt: (version >= 4 && (flags & 4) !== 0) ? c.uint.decode(state) : 0,
      updatedAt: (version >= 4 && (flags & 8) !== 0) ? c.uint.decode(state) : 0
    }
  }
}
...
const encoding263 = {
  preencode(state, m) {
    ...
    if (version >= 4 && m.channelKey) c.string.preencode(state, m.channelKey)
    if (version >= 4 && m.videoId) c.string.preencode(state, m.videoId)
    if (version >= 4 && m.addedAt) c.uint.preencode(state, m.addedAt)
  },
  encode(state, m) {
    const flags =
      ((version >= 4 && m.channelKey) ? 1 : 0) |
      ((version >= 4 && m.videoId) ? 2 : 0) |
      ((version >= 4 && m.addedAt) ? 4 : 0)

    c.string.encode(state, m.playlistId)
    c.string.encode(state, m.videoKey)
    c.uint.encode(state, flags)

    if (version >= 4 && m.channelKey) c.string.encode(state, m.channelKey)
    if (version >= 4 && m.videoId) c.string.encode(state, m.videoId)
    if (version >= 4 && m.addedAt) c.uint.encode(state, m.addedAt)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const r1 = c.string.decode(state)
    ...
    return {
      playlistId: r0,
      videoKey: r1,
      channelKey: (version >= 4 && (flags & 1) !== 0) ? c.string.decode(state) : null,
      videoId: (version >= 4 && (flags & 2) !== 0) ? c.string.decode(state) : null,
      addedAt: (version >= 4 && (flags & 4) !== 0) ? c.uint.decode(state) : 0
    }
  }
}
...
const encoding264 = {
  preencode(state, m) {
    const flags =
      ((version >= 4 && m.eventId) ? 1 : 0) |
      ((version >= 4 && m.channelKey) ? 2 : 0) |
      ((version >= 4 && m.videoId) ? 4 : 0) |
      ((version >= 4 && m.videoKey) ? 8 : 0) |
      ((version >= 4 && m.title) ? 16 : 0) |
      ((version >= 4 && m.duration) ? 32 : 0) |
      ((version >= 4 && m.position) ? 64 : 0) |
      ((version >= 4 && m.completed) ? 128 : 0) |
      ((version >= 4 && m.timestamp) ? 256 : 0)

    c.uint.preencode(state, flags)

    if (version >= 4 && m.eventId) c.string.preencode(state, m.eventId)
    if (version >= 4 && m.channelKey) c.string.preencode(state, m.channelKey)
    if (version >= 4 && m.videoId) c.string.preencode(state, m.videoId)
    if (version >= 4 && m.videoKey) c.string.preencode(state, m.videoKey)
    if (version >= 4 && m.title) c.string.preencode(state, m.title)
    if (version >= 4 && m.duration) c.uint.preencode(state, m.duration)
    if (version >= 4 && m.position) c.uint.preencode(state, m.position)
    if (version >= 4 && m.timestamp) c.uint.preencode(state, m.timestamp)
  },
  encode(state, m) {
    const flags =
      ((version >= 4 && m.eventId) ? 1 : 0) |
    ...
    if (version >= 4 && m.eventId) c.string.encode(state, m.eventId)
    if (version >= 4 && m.channelKey) c.string.encode(state, m.channelKey)
    if (version >= 4 && m.videoId) c.string.encode(state, m.videoId)
    if (version >= 4 && m.videoKey) c.string.encode(state, m.videoKey)
    if (version >= 4 && m.title) c.string.encode(state, m.title)
    if (version >= 4 && m.duration) c.uint.encode(state, m.duration)
    if (version >= 4 && m.position) c.uint.encode(state, m.position)
    if (version >= 4 && m.timestamp) c.uint.encode(state, m.timestamp)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      eventId: (version >= 4 && (flags & 1) !== 0) ? c.string.decode(state) : null,
      channelKey: (version >= 4 && (flags & 2) !== 0) ? c.string.decode(state) : null,
      videoId: (version >= 4 && (flags & 4) !== 0) ? c.string.decode(state) : null,
      videoKey: (version >= 4 && (flags & 8) !== 0) ? c.string.decode(state) : null,
      title: (version >= 4 && (flags & 16) !== 0) ? c.string.decode(state) : null,
      duration: (version >= 4 && (flags & 32) !== 0) ? c.uint.decode(state) : 0,
      position: (version >= 4 && (flags & 64) !== 0) ? c.uint.decode(state) : 0,
      completed: (version >= 4 && (flags & 128) !== 0),
      timestamp: (version >= 4 && (flags & 256) !== 0) ? c.uint.decode(state) : 0
    }
  }
}
...
const encoding265 = {
  ...
  encode(state, m) {
    const flags =
      ((version >= 4 && m.channelKey) ? 1 : 0) |
      ((version >= 4 && m.videoId) ? 2 : 0) |
      ((version >= 4 && m.position) ? 4 : 0) |
      ((version >= 4 && m.duration) ? 8 : 0) |
      ((version >= 4 && m.completed) ? 16 : 0) |
      ((version >= 4 && m.updatedAt) ? 32 : 0)
  ...
  decode(state) {
    ...
    return {
      ...
      channelKey: (version >= 4 && (flags & 1) !== 0) ? c.string.decode(state) : null,
      videoId: (version >= 4 && (flags & 2) !== 0) ? c.string.decode(state) : null,
      position: (version >= 4 && (flags & 4) !== 0) ? c.uint.decode(state) : 0,
      duration: (version >= 4 && (flags & 8) !== 0) ? c.uint.decode(state) : 0,
      completed: (version >= 4 && (flags & 16) !== 0),
      updatedAt: (version >= 4 && (flags & 32) !== 0) ? c.uint.decode(state) : 0
    }
  }
}
...
const encoding266 = {
  preencode(state, m) {
    ...
    if (version >= 4 && m.value) c.string.preencode(state, m.value)
  },
  encode(state, m) {
    const flags = (version >= 4 && m.value) ? 1 : 0

    c.string.encode(state, m.key)
    c.uint.encode(state, flags)

    if (version >= 4 && m.value) c.string.encode(state, m.value)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const flags = c.uint.decode(state)
    ...
    return {
      key: r0,
      value: (version >= 4 && (flags & 1) !== 0) ? c.string.decode(state) : null
    }
  }
}

// @peartube/get-playlists-request
const encoding267 = encoding0

// @peartube/get-playlists-response.playlists
const encoding268_0 = c.array(c.frame(encoding262))
...
const encoding268 = {
  preencode(state, m) {
    ...
    if (version >= 4 && m.playlists) encoding268_0.preencode(state, m.playlists)
  },
  encode(state, m) {
    const flags = (version >= 4 && m.playlists) ? 1 : 0

    c.uint.encode(state, flags)

    if (version >= 4 && m.playlists) encoding268_0.encode(state, m.playlists)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      playlists: (version >= 4 && (flags & 1) !== 0) ? encoding268_0.decode(state) : null
    }
  }
}
...
const encoding270_0 = c.array(c.frame(encoding263))
...
const encoding270 = {
  preencode(state, m) {
    ...
    if (version >= 4 && m.items) encoding270_0.preencode(state, m.items)
  },
  encode(state, m) {
    const flags = (version >= 4 && m.items) ? 1 : 0

    c.uint.encode(state, flags)

    if (version >= 4 && m.items) encoding270_0.encode(state, m.items)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      items: (version >= 4 && (flags & 1) !== 0) ? encoding270_0.decode(state) : null
    }
  }
}
...
const encoding271 = {
  ...
  encode(state, m) {
    const flags = ((version >= 4 && m.name) ? 1 : 0) | ((version >= 4 && m.description) ? 2 : 0)
...
const encoding272 = {
  preencode(state, m) {
    ...
    if (version >= 4 && m.id) c.string.preencode(state, m.id)
  },
  encode(state, m) {
    const flags = ((version >= 4 && m.success) ? 1 : 0) | ((version >= 4 && m.id) ? 2 : 0)

    c.uint.encode(state, flags)

    if (version >= 4 && m.id) c.string.encode(state, m.id)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      id: (version >= 4 && (flags & 2) !== 0) ? c.string.decode(state) : null
    }
  }
}
...
const encoding277 = {
  ...
  decode(state) {
    ...
    return {
      ...
      channelKey: (version >= 4 && (flags & 1) !== 0) ? c.string.decode(state) : null,
      videoId: (version >= 4 && (flags & 2) !== 0) ? c.string.decode(state) : null,
      videoKey: (version >= 4 && (flags & 4) !== 0) ? c.string.decode(state) : null
    }
  }
}

// @peartube/add-to-playlist-response
const encoding278 = encoding274
...
const encoding281 = {
  preencode(state, m) {
    const flags =
      ...
      ((version >= 4 && m.videoId) ? 2 : 0) |
      ((version >= 4 && m.videoKey) ? 4 : 0) |
      ((version >= 4 && m.title) ? 8 : 0) |
      ((version >= 4 && m.duration) ? 16 : 0) |
      ((version >= 4 && m.position) ? 32 : 0) |
      ((version >= 4 && m.completed) ? 64 : 0) |
      ((version >= 4 && m.timestamp) ? 128 : 0)
  ...
  decode(state) {
    ...
    return {
      ...
      videoId: (version >= 4 && (flags & 2) !== 0) ? c.string.decode(state) : null,
      videoKey: (version >= 4 && (flags & 4) !== 0) ? c.string.decode(state) : null,
      title: (version >= 4 && (flags & 8) !== 0) ? c.string.decode(state) : null,
      duration: (version >= 4 && (flags & 16) !== 0) ? c.uint.decode(state) : 0,
      position: (version >= 4 && (flags & 32) !== 0) ? c.uint.decode(state) : 0,
      completed: (version >= 4 && (flags & 64) !== 0),
      timestamp: (version >= 4 && (flags & 128) !== 0) ? c.uint.decode(state) : 0
    }
  }
}
...
const encoding282 = {
  ...
  encode(state, m) {
    const flags = ((version >= 4 && m.success) ? 1 : 0) | ((version >= 4 && m.eventId) ? 2 : 0)
  ...
  decode(state) {
    ...
    return {
      success: (version >= 4 && (flags & 1) !== 0),
      eventId: (version >= 4 && (flags & 2) !== 0) ? c.string.decode(state) : null
    }
  }
}
...
const encoding284_0 = c.array(c.frame(encoding264))
...
const encoding284 = {
  preencode(state, m) {
    ...
    if (version >= 4 && m.entries) encoding284_0.preencode(state, m.entries)
  },
  encode(state, m) {
    const flags = (version >= 4 && m.entries) ? 1 : 0

    c.uint.encode(state, flags)

    if (version >= 4 && m.entries) encoding284_0.encode(state, m.entries)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      entries: (version >= 4 && (flags & 1) !== 0) ? encoding284_0.decode(state) : null
    }
  }
}
...
const encoding286_1 = c.frame(encoding265)
...
const encoding286 = {
  preencode(state, m) {
    ...
    if (version >= 4 && m.resume) encoding286_1.preencode(state, m.resume)
  },
  encode(state, m) {
    const flags = ((version >= 4 && m.found) ? 1 : 0) | ((version >= 4 && m.resume) ? 2 : 0)

    c.uint.encode(state, flags)

    if (version >= 4 && m.resume) encoding286_1.encode(state, m.resume)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      found: (version >= 4 && (flags & 1) !== 0),
      resume: (version >= 4 && (flags & 2) !== 0) ? encoding286_1.decode(state) : null
    }
  }
}
...
const encoding288_0 = c.array(c.frame(encoding265))
...
const encoding288 = {
  preencode(state, m) {
    ...
    if (version >= 4 && m.entries) encoding288_0.preencode(state, m.entries)
  },
  encode(state, m) {
    const flags = (version >= 4 && m.entries) ? 1 : 0
    ...
    if (version >= 4 && m.entries) encoding288_0.encode(state, m.entries)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      entries: (version >= 4 && (flags & 1) !== 0) ? encoding288_0.decode(state) : null
    }
  }
}

// @peartube/set-personal-setting-request
const encoding289 = encoding266

// @peartube/set-personal-setting-response
const encoding290 = encoding274

// @peartube/get-personal-settings-request
const encoding291 = encoding0

// @peartube/get-personal-settings-response.settings
const encoding292_0 = c.array(c.frame(encoding266))
...
const encoding292 = {
  preencode(state, m) {
    ...
    if (version >= 4 && m.settings) encoding292_0.preencode(state, m.settings)
  },
  encode(state, m) {
    const flags = (version >= 4 && m.settings) ? 1 : 0

    c.uint.encode(state, flags)

    if (version >= 4 && m.settings) encoding292_0.encode(state, m.settings)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      settings: (version >= 4 && (flags & 1) !== 0) ? encoding292_0.decode(state) : null
    }
  }
}
...
const encoding293 = {
  preencode(state, m) {
    ...
    if (version >= 5 && m.secret) c.string.preencode(state, m.secret)
  },
  encode(state, m) {
    const flags = (version >= 5 && m.secret) ? 1 : 0

    c.uint.encode(state, flags)

    if (version >= 5 && m.secret) c.string.encode(state, m.secret)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      secret: (version >= 5 && (flags & 1) !== 0) ? c.string.decode(state) : null
    }
  }
}
...
const encoding294 = {
  ...
  encode(state, m) {
    const flags =
      ...
      ((version >= 5 && m.secret) ? 2 : 0) |
      ((version >= 5 && m.encrypted) ? 4 : 0) |
      ((version >= 5 && m.error) ? 8 : 0)
  ...
  decode(state) {
    ...
    return {
      ...
      secret: (version >= 5 && (flags & 2) !== 0) ? c.string.decode(state) : null,
      encrypted: (version >= 5 && (flags & 4) !== 0),
      error: (version >= 5 && (flags & 8) !== 0) ? c.string.decode(state) : null
    }
  }
}

// @peartube/get-personal-encryption-secret-request
const encoding295 = encoding0
...
const encoding296 = {
  ...
  encode(state, m) {
    const flags = ((version >= 5 && m.provisioned) ? 1 : 0) | ((version >= 5 && m.secret) ? 2 : 0)
  ...
  decode(state) {
    ...
    return {
      provisioned: (version >= 5 && (flags & 1) !== 0),
      secret: (version >= 5 && (flags & 2) !== 0) ? c.string.decode(state) : null
    }
  }
}
...
// @peartube/feed-entry.liveStreams, deferred due to recusive use
const encoding57_14 = c.array(c.frame(encoding261))
...
function getEncoding(name) {
  switch (name) {
    ...
    case '@peartube/provision-personal-encryption-response':
      return encoding294
    case '@peartube/get-personal-encryption-secret-request':
      return encoding295
    case '@peartube/get-personal-encryption-secret-response':
      return encoding296
    default:
