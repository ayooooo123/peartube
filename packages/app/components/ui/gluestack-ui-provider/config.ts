...
export const config = {
  ...
  dark: vars({
    "--color-primary-0": "#1A2E05",
    "--color-primary-50": "#3F6212",
    "--color-primary-100": "#4D7C0F",
    "--color-primary-200": "#65A30D",
    "--color-primary-300": "#84CC16",
    "--color-primary-400": "#A3E635",
    "--color-primary-500": "#A3E635",
    "--color-primary-600": "#BEF264",
    "--color-primary-700": "#CDF381",
    "--color-primary-800": "#D9F99D",
    "--color-primary-900": "#ECFCCB",
    "--color-primary-950": "#F4FFD6",
